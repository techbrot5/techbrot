...
& $chrome --headless --disable-gpu --hide-scrollbars --window-size="$Width,900" --virtual-time-budget=8000 --screenshot="$shots\$Out" "http://localhost:$Port/dev-anchor-probe.html" | Out-Null
