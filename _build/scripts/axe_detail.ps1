...
$line = & $chrome --headless=new --user-data-dir=C:\tb-probe-profile --disable-gpu --hide-scrollbars --virtual-time-budget=25000 --dump-dom "http://localhost:8090/dev-axe-d.html" 2>$null |
