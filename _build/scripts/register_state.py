...
STATES = {
    ...
    "arizona": {
        "name": "Arizona",
        "intent": {
            "headline": "Tell us about your Arizona books.<br>We&rsquo;ll handle the rest.",
            "lede": "A Certified QuickBooks ProAdvisor reviews where your Arizona books stand &mdash; the flat 2.5% income tax, the Transaction Privilege Tax (TPT) by business classification with state, county, and city layers, the prime-contracting 65% rule for construction, state-only withholding with the 60-day nonresident rule and the CA/IN/OR/VA exemption, and the PTE election &mdash; recommends the right engagement, and delivers a written fixed-fee scope within 3 business days. We don&rsquo;t file Arizona returns, the corporate or individual income tax, or the TPT return; we keep clean, CPA-ready books and coordinate with your CPA. If TechBrot isn&rsquo;t the right fit, we&rsquo;ll say so.",
            "service": "not-sure",
            "cta": "Book the discovery call",
            "_added": "T5 location expansion — AZ core-state pillar (areaServed-only, no street address). State-slug intent.",
        },
        "advisory": {
            "headline": "Advisory for Arizona businesses<br>ready to move beyond the books.",
            "lede": "Fractional CFO and advisory for Arizona businesses &mdash; forecasting, board reporting, KPI design, TPT and prime-contracting planning, PTE coordination, multi-state nexus &mdash; coordinated with your Arizona CPA. A Certified ProAdvisor reviews your situation and tells you honestly whether advisory is the right next step.",
            "service": "fractional-cfo",
            "cta": "Book the discovery call",
            "_added": "T5 location expansion — AZ advisory route.",
        },
    },
    "tennessee": {
        "name": "Tennessee",
        "intent": {
            "headline": "Tell us about your Tennessee books.<br>We&rsquo;ll handle the rest.",
            "lede": "A Certified QuickBooks ProAdvisor reviews where your Tennessee books stand &mdash; no individual income tax (the Hall tax was repealed in 2021, so payroll has no state withholding), the Franchise &amp; Excise (F&amp;E) tax (a 6.5% excise on net earnings plus a 0.25% franchise tax on net worth), the business (gross-receipts) tax at $100,000 across state and city, and one of the highest combined sales-tax rates in the country (7% state plus a local option up to 2.75%) &mdash; recommends the right engagement, and delivers a written fixed-fee scope within 3 business days. We don&rsquo;t file Tennessee returns, the F&amp;E return, the business-tax return, or the sales-tax return; we keep clean, CPA-ready books and coordinate with your CPA. If TechBrot isn&rsquo;t the right fit, we&rsquo;ll say so.",
            "service": "not-sure",
            "cta": "Book the discovery call",
            "_added": "T5 location expansion — TN core-state pillar (areaServed-only, no street address). State-slug intent.",
        },
        "advisory": {
            "headline": "Advisory for Tennessee businesses<br>ready to move beyond the books.",
            "lede": "Fractional CFO and advisory for Tennessee businesses &mdash; forecasting, board reporting, KPI design, F&amp;E and business-tax planning, multi-state nexus &mdash; coordinated with your Tennessee CPA. A Certified ProAdvisor reviews your situation and tells you honestly whether advisory is the right next step.",
            "service": "fractional-cfo",
            "cta": "Book the discovery call",
            "_added": "T5 location expansion — TN advisory route.",
        },
    },
    "washington": {
        "name": "Washington",
        "intent": {
            "headline": "Tell us about your Washington books.<br>We&rsquo;ll handle the rest.",
            "lede": "A Certified QuickBooks ProAdvisor reviews where your Washington books stand &mdash; no income tax (so no state withholding), the B&amp;O gross-receipts tax (by classification, with no deduction for costs, plus city B&amp;O in Seattle, Tacoma, Bellevue, and Everett), the high combined sales/use tax (6.5% state plus local), the 7% capital-gains tax on owners, and the WA payroll premiums (Paid Family &amp; Medical Leave and WA Cares) &mdash; recommends the right engagement, and delivers a written fixed-fee scope within 3 business days. We don&rsquo;t file Washington returns, the B&amp;O/Combined Excise Tax Return, the sales-tax return, or the capital-gains tax; we keep clean, CPA-ready books and coordinate with your CPA. If TechBrot isn&rsquo;t the right fit, we&rsquo;ll say so.",
            "service": "not-sure",
            "cta": "Book the discovery call",
            "_added": "T5 location expansion — WA core-state pillar (areaServed-only, no street address). State-slug intent.",
        },
        "advisory": {
            "headline": "Advisory for Washington businesses<br>ready to move beyond the books.",
            "lede": "Fractional CFO and advisory for Washington businesses &mdash; forecasting, board reporting, KPI design, B&amp;O classification and capital-gains planning, multi-state nexus &mdash; coordinated with your Washington CPA. A Certified ProAdvisor reviews your situation and tells you honestly whether advisory is the right next step.",
            "service": "fractional-cfo",
            "cta": "Book the discovery call",
    ...
    "massachusetts": {
        "name": "Massachusetts",
        "intent": {
            "headline": "Tell us about your Massachusetts books.<br>We&rsquo;ll handle the rest.",
            "lede": "A Certified QuickBooks ProAdvisor reviews where your Massachusetts books stand &mdash; the 5% flat income tax (with Massachusetts state withholding), the 4% surtax on income over the indexed threshold (about $1.1M, so clean owner-compensation, distribution, and timing records matter), the corporate excise (the 8% net-income measure plus a property/net-worth measure of $2.60 per $1,000, $456 minimum), MA Paid Family &amp; Medical Leave, the PTE election, and the flat 6.25% sales tax (no local add-on) &mdash; recommends the right engagement, and delivers a written fixed-fee scope within 3 business days. We don&rsquo;t file Massachusetts returns, the income tax or 4% surtax, the corporate excise, the sales-tax return, or the PTE election; we keep clean, CPA-ready books and coordinate with your CPA. If TechBrot isn&rsquo;t the right fit, we&rsquo;ll say so.",
            "service": "not-sure",
            "cta": "Book the discovery call",
            "_added": "T5 location expansion — MA core-state pillar (final core state; areaServed-only, no street address). State-slug intent.",
        },
        "advisory": {
            "headline": "Advisory for Massachusetts businesses<br>ready to move beyond the books.",
            "lede": "Fractional CFO and advisory for Massachusetts businesses &mdash; forecasting, board reporting, KPI design, 4% surtax and PTE-election planning, multi-state nexus &mdash; coordinated with your Massachusetts CPA. A Certified ProAdvisor reviews your situation and tells you honestly whether advisory is the right next step.",
            "service": "fractional-cfo",
            "cta": "Book the discovery call",
            "_added": "T5 location expansion — MA advisory route.",
        },
    },
}
