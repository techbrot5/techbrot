...
**COUNT: total pages live = 556 (orientation `*.html` non-dev count; prior 553 − 1 /accounting/pricing/ + 4 new) · re-skinned (142) + growth = 414 · LAST COMMIT = round-90 QB money pages (distinct-only) + merges. Working tree clean on `preview-11ty`.
