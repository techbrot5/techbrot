...
| **D4/D5/D6 (state children, ~90)** | t-location | **🔜 NEXT — assessed** | ~55 cities + ~32 industries + ~5 service-landings (26 on t-location + 25 on t-bofu). NOT D3-style data-driven (divergent schema ids) → needs D1/D2-style per-page body→v2 recompose, NY frozen, RATE-FREE tax viz. Chrome-only shortcut tried + REVERTED. Largest family; fresh context. |
