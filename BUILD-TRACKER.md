...
**STATES: 8 built / 20 planned** (5 existing NY·CA·TX·FL·IL + DE + IN + **PA**; 12 core remain: NJ·MD·VA·OH·MI·GA·NC·AZ·TN·WA·CO·MA — ALL pre-flip). **NEXT: New Jersey** (NJ-FACTS.md vs NJ Div. of Taxation FIRST → pillar + 5 essentials on the PA exemplar → battery → commit).
