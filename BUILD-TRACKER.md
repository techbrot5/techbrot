...
**STATES: 9 built / 20 planned** (5 existing NY·CA·TX·FL·IL + DE + IN + PA + **NJ**; 11 core remain: MD·VA·OH·MI·GA·NC·AZ·TN·WA·CO·MA — ALL pre-flip). **NEXT: Maryland** (MD-FACTS.md vs Comptroller of Maryland FIRST → pillar + 5 essentials on the PA/NJ exemplar → battery → commit).
