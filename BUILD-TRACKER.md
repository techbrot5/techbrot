...
**COUNT: total pages live = 423 · re-skinned (142) + growth = 281 · LAST COMMIT = round-71 QBO-features-w3+hub
(7: cash-flow-planner, custom-fields, payroll, products-services, projects, time-tracking + the FEATURES HUB /quickbooks/online/features/). Working tree clean on `preview-11ty`.
QBO FEATURES ✅ 20/20 + hub DONE. All 20 feature pages' "Features" breadcrumb crumb (visible + JSON-LD) re-pointed to the new hub. NEXT in GROUP 2: online/integrations (9 + hub) → online/advanced (10 + hub).
