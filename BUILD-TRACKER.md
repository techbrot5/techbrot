...
**STATES: 11 built / 20 planned** (5 existing NY·CA·TX·FL·IL + DE + IN + PA + NJ + MD + **VA**; 9 core remain: OH·MI·GA·NC·AZ·TN·WA·CO·MA — ALL pre-flip). **NEXT: Ohio** (OH-FACTS.md vs Ohio Dept of Taxation FIRST → pillar + 5 essentials → battery → commit; starts Wave B = Midwest. OH-distinct = CAT commercial-activity tax + municipal income tax/RITA-CCA).
