...
**STATES: 10 built / 20 planned** (5 existing NY·CA·TX·FL·IL + DE + IN + PA + NJ + **MD**; 10 core remain: VA·OH·MI·GA·NC·AZ·TN·WA·CO·MA — ALL pre-flip). **NEXT: Virginia** (VA-FACTS.md vs Virginia Dept of Taxation FIRST → pillar + 5 essentials on the exemplar → battery → commit; finishes Wave A).
