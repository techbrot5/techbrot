...
**STATES: 12 built / 20 planned** (5 existing NY·CA·TX·FL·IL + DE + IN + PA + NJ + MD + VA + **OH**; 8 core remain: MI·GA·NC·AZ·TN·WA·CO·MA — ALL pre-flip). **NEXT: Michigan** (MI-FACTS.md vs Michigan Dept of Treasury FIRST → pillar + 5 essentials → battery → commit; finishes Wave B. MI-distinct = flat 4.25% income tax + city income taxes [Detroit etc.] + CIT).
