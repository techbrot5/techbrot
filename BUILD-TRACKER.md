...
**COUNT: total pages live = 416 · re-skinned (142) + growth = 274 · LAST COMMIT = round-70 QBO-features-w2
(8: bank-rules, bills, budgeting, chart-of-accounts, classes, customers, estimates, expenses). Working tree clean on `preview-11ty`.
QBO FEATURES 14/20 done. REMAINING (6): cash-flow-planner, custom-fields, payroll, products-services, projects, time-tracking + the features HUB (build last; re-point Features breadcrumb crumb to it).
...
GROUP 1 (QB cleanup) ✅ COMPLETE (11; file-review skipped as 301 dup). GROUP 2 (QB online features 21+hub / integrations 9+hub / advanced 10+hub) IN PROGRESS: features 6/21 done (bank-feeds, invoices, inventory, reports, reconciliation, sales-tax). REMAINING features: bank-rules, bills, budgeting, cash-flow-planner, chart-of-accounts, classes, custom-fields, customers, estimates, expenses, payroll, products-services, projects, time-tracking, customers... + the features HUB (build last, re-point the "Features" breadcrumb crumb to it). Then integrations + advanced + their hubs.
