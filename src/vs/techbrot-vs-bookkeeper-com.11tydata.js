...
module.exports = {
  ...
  faq: [
    { q: "Is TechBrot basically the same as Bookkeeper.com?", a: "They overlap as remote bookkeeping services, but they&rsquo;re structured differently. TechBrot works inside your own QuickBooks file with one named Certified ProAdvisor and fixed-fee scopes, and coordinates with your CPA for tax. Bookkeeper.com is a larger national service that also bundles payroll and tax, often through its own workflow and team. The trade is depth-and-ownership versus breadth-and-bundling." },
