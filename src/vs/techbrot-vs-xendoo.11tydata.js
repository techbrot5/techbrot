...
module.exports = {
  ...
  faq: [
    ...
    { q: "Which is better for a brand-new business?", a: "It depends on whether you want flat-rate books with optional tax in one app (Xendoo&rsquo;s strength) or a clean QuickBooks setup with deep bookkeeping and your own choice of tax pro (TechBrot&rsquo;s strength). For a new business, getting <a href=\"/quickbooks/\">QuickBooks set up correctly</a> from day one matters a lot &mdash; that&rsquo;s squarely what a ProAdvisor does &mdash; but if you value a single predictable bill and a turnkey app over file ownership, Xendoo may suit you better. To talk through which fits, call <a href=\"tel:+18777515575\">(877) 751-5575</a>." },
