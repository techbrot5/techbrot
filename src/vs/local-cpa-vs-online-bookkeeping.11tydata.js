...
module.exports = {
  ...
  faq: [
    ...
    { q: "Where does TechBrot fit — local CPA or online bookkeeping?", a: "The online bookkeeping side. We deliver monthly bookkeeping, cleanup, catch-up, QuickBooks expertise, payroll, and sales-tax compliance remotely inside your QuickBooks file, with named operators and fixed-fee scopes &mdash; and we coordinate with your local CPA for tax filing and licensed work. We don&rsquo;t file returns ourselves. The model gives you a real bookkeeping partner plus a clean handoff to your tax pro." },
  ],
  related: [
