...
module.exports = {
  ...
  faq: [
    ...
    { q: "Which is better for a brand-new business?", a: "It depends on whether you want bookkeeping and taxes bundled (1-800Accountant&rsquo;s strength) or a clean QuickBooks setup with deep bookkeeping and your own choice of tax pro (TechBrot&rsquo;s strength). For a new business, getting QuickBooks set up correctly from day one matters a lot &mdash; that&rsquo;s squarely what a ProAdvisor does." },
