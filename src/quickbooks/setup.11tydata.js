...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a setup?", a: "Yes — start with a free 30-minute setup diagnostic, no obligation. A Certified ProAdvisor reviews your business structure, industry, and integration needs, recommends the right QuickBooks product, and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-setup\">book the diagnostic</a>. Most setups then transition directly into <a href=\"/accounting/bookkeeping/monthly-bookkeeping/?intent=monthly\">monthly bookkeeping</a> with the same operator." },
