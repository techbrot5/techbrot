...
module.exports = {
  ...
  faq: [
    ...
    { q: "How much does QuickBooks setup cost?", a: "A fixed one-time engagement: typically $750 for simple single-entity setups, $1,500–$3,000 for standard small-business implementations, and $3,000–$5,000+ for complex multi-entity, multi-state, or industry-specific work. The diagnostic call produces a written scope before work begins — book it online or call <a href=\"tel:+18777515575\">(877) 751-5575</a>. Software subscription costs are separate and pass through at Intuit list pricing." },
    ...
    { q: "What if my books are already in QuickBooks but the setup is wrong?", a: "That’s common. Depending on the damage, it’s either a <a href=\"/quickbooks/cleanup/?intent=qb-cleanup\">cleanup</a> (correcting errors and reconciliations in place) or a re-setup (rebuilding the chart of accounts and configuration). The diagnostic tells you which path fits and prices it in writing before any work begins." },
  ],
  eleventyComputed: {
    pageGraph(data){
