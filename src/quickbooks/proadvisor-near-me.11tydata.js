...
module.exports = {
  ...
  faq: [
    ...
    { q: "How do I reach a Certified ProAdvisor?", a: "Call (877) 751-5575 to speak with an independent Certified QuickBooks ProAdvisor directly &mdash; an independent firm&rsquo;s advisory line, not Intuit support. You can also start with a <a href=\"/quickbooks/file-review/?intent=file-review\">free QuickBooks file review</a> or book a free 30-minute discovery call; either way you get a named ProAdvisor and a written fixed-fee scope within 3 business days, no obligation." },
  ],
