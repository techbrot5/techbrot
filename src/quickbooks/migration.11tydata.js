...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a migration?", a: "Yes — start with a free 30-minute migration diagnostic, no obligation. A Certified ProAdvisor reviews your current platform, years of history, integrations, and any structural issues, then sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-migration\">book the diagnostic</a>. Moving off another platform? Cross-platform engagements like <a href=\"/quickbooks/migration/desktop-to-online/?intent=desktop-to-online\">Desktop to Online</a> are scoped the same way." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"speakable":{"@type":"SpeakableSpecification","cssSelector":["#migration-in-brief-text"]}},
