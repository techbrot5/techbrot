...
module.exports = {
  ...
  faq: [
    ...
    { q: "How much does QuickBooks Desktop to Online migration cost?", a: "A fixed one-time engagement, typically $2,500–$10,000+. Simple migrations (single-entity, under 3 years) run $2,500–$4,500; standard (multi-year, 3–6 integrations, payroll) $4,500–$7,500; complex (multi-entity, Enterprise, 6+ integrations) $7,500–$10,000+. The written scope is fixed before work begins — for a quote, book a free call or dial <a href=\"tel:+18777515575\">(877) 751-5575</a>." },
    { q: "Can I just use Intuit’s free migration tool?", a: "Intuit’s free tool handles the data transfer but doesn’t review accuracy, redesign the chart of accounts for QBO, replace Desktop integrations, or reconcile history. Most migrations we deliver exist because the free tool ran but the result wasn’t usable — broken feeds, missing integrations, an unusable chart of accounts, off opening balances. That repair work is <a href=\"/quickbooks/migration/migration-cleanup/\">migration cleanup</a>." },
