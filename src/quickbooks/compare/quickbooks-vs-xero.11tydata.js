...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can TechBrot help me decide, even if the answer turns out to be Xero?", a: "Yes. We&rsquo;d rather give you the right recommendation than win a client for the wrong platform. On a discovery call we look at your business size, your team, the specific integrations you depend on, and who you want supporting your books &mdash; or talk it through by phone at <a href=\"tel:+18777515575\">(877) 751-5575</a> &mdash; then we tell you honestly whether <a href=\"/quickbooks/online/\">QuickBooks Online</a> or Xero is the better fit. We go deepest in QuickBooks as Certified ProAdvisors, so we&rsquo;ll also be candid about where that depth benefits QuickBooks clients. But if Xero is genuinely right for you, we&rsquo;ll say so plainly." },
    { q: "We already use Xero &mdash; should we switch to QuickBooks?", a: "Not automatically. If Xero is working for you, your team likes it, and your accountant supports it, switching has real costs and isn&rsquo;t worth it just to be on QuickBooks. A migration makes sense when something is actually pushing you &mdash; for instance, you can&rsquo;t find local Xero support in the U.S., you need a U.S.-centric payroll or sales-tax integration that fits QuickBooks better, or you&rsquo;ve hired an accountant who works in QuickBooks. If you are considering the move, we maintain an honest <a href=\"/quickbooks/migration/quickbooks-to-xero/\">QuickBooks-to-Xero migration</a> guide for the reverse direction too, and we&rsquo;re glad to talk through whether a switch is even worth it for you." },
  ],
  eleventyComputed: {
    pageGraph(data){
      const url="https://techbrot.com/quickbooks/compare/quickbooks-vs-xero/";
      return {"@context":"https://schema.org","@graph":[
        {"@type":["CollectionPage","WebPage"],"@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#cmp-qb-vs-xero-in-brief-text"]}},
