...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can TechBrot help me move from Zoho Books to QuickBooks Online?", a: "Yes. We handle the full transition: a QuickBooks migration sets up your new file and brings your history across, a cleanup engagement reconciles and corrects anything that didn&rsquo;t carry over cleanly, and ongoing monthly bookkeeping continues from there with the same operator. That said, we won&rsquo;t push you to switch if you shouldn&rsquo;t &mdash; if you&rsquo;re deeply invested in the Zoho ecosystem and it&rsquo;s serving you, we&rsquo;ll tell you. A good first step is a free file review, where we give you an honest read on whether moving makes sense for your situation." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":["CollectionPage","WebPage"],"@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"lastReviewed":"2026-06-18","speakable":{"@type":"SpeakableSpecification","cssSelector":["#cmp-qb-vs-zoho-in-brief-text"]}},
