...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I upgrade or downgrade my plan later?", a: "Yes. QuickBooks Online lets you change tiers as your needs evolve, and your data carries forward when you upgrade. The practical concern is starting a tier too low and being forced into a quick upgrade, or paying for Plus or Advanced capabilities you never use. A brief file review usually clarifies the right starting tier so you don&rsquo;t over- or under-buy &mdash; our <a href=\"/quickbooks/which-plan-is-right/\">which plan is right for you</a> guide walks your situation to a recommendation, or talk it through with a ProAdvisor at <a href=\"tel:+18777515575\">(877) 751-5575</a>." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":["CollectionPage","WebPage"],"@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#cmp-online-plans-in-brief-text"]}},
