...
module.exports = {
  ...
  faq: [
    ...
    { q: "Will my data move cleanly if I switch from Desktop to Online?", a: "Most of it transfers, and a planned migration protects what matters &mdash; your transaction history, your chart of accounts, and your reporting. Some Desktop-specific features and certain lists do not map one-to-one to Online, so part of a good migration is rebuilding those deliberately and reconciling the result rather than assuming a perfect copy. That is exactly the kind of work a ProAdvisor handles, and our Desktop-to-Online migration guidance walks through what transfers, what gets rebuilt, and how to verify the file is right before you rely on it." },
  ],
  eleventyComputed: {
    pageGraph(data){
      const url="https://techbrot.com/quickbooks/compare/online-vs-desktop/";
      return {"@context":"https://schema.org","@graph":[
        {"@type":["CollectionPage","WebPage"],"@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"lastReviewed":"2026-06-18","speakable":{"@type":"SpeakableSpecification","cssSelector":["#cmp-online-vs-desktop-in-brief-text"]}},
