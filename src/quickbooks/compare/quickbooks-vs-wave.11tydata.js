...
module.exports = {
  ...
  faq: [
    ...
    { q: "Why would I pay for QuickBooks Online when Wave is free?", a: "Because depth and scale are worth paying for once you need them. <a href=\"/quickbooks/online/\">QuickBooks Online</a> offers inventory, projects, classes and locations, multi-user role-based access, and far more powerful, customizable reporting than a free tool provides. It&rsquo;s also the platform most U.S. accountants and Certified ProAdvisors work in every day, with the deepest library of app integrations. If your business is growing or already complex, those capabilities save time and money that a free tool can&rsquo;t. If your books are genuinely simple, you may not need them yet &mdash; and that&rsquo;s a fair reason to stay on Wave for now." },
    ...
    { q: "Can TechBrot help me move from Wave to QuickBooks Online?", a: "Yes. We handle the full transition: a <a href=\"/quickbooks/migration/\">QuickBooks migration</a> sets up your new file and brings your history across, a cleanup engagement reconciles and corrects anything that didn&rsquo;t carry over cleanly, and ongoing monthly bookkeeping continues from there with the same operator. To start, call a ProAdvisor at <a href=\"tel:+18777515575\">(877) 751-5575</a>. A good first step is a free file review &mdash; we&rsquo;ll tell you honestly whether you&rsquo;re actually ready to move or whether staying on Wave a while longer makes more sense for now." },
