...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a Payroll ProAdvisor before I commit?", a: "Yes — start with a no-obligation call. A Certified QuickBooks Payroll ProAdvisor reviews your setup, states, and any notices you've received, then scopes the right fixed-fee engagement in writing. Call (877) 751-5575 or <a href=\"/contact/?intent=qb-payroll-setup\">request the call</a>. If you'd rather not run payroll yourself at all, ask about ongoing <a href=\"/accounting/payroll-management/?intent=payroll\">payroll management</a>." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"speakable":{"@type":"SpeakableSpecification","cssSelector":["#payroll-in-brief-text"]}},
