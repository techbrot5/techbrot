...
module.exports = {
  ...
  sources: [
    { opener: "Xero to QuickBooks", body: "The most common cross-platform move. Xero&rsquo;s chart of accounts, contacts, and transaction structure mapped to QuickBooks &mdash; with a Dataswitcher-assisted conversion where it fits &mdash; and balances and AR/AP reconciled to the source. (Intuit points Xero users to a Dataswitcher-assisted path; it covers roughly the current plus one or two prior fiscal years and rolls older periods into an opening balance.)" },
    { opener: "FreshBooks to QuickBooks", body: "Businesses outgrowing FreshBooks&rsquo; invoicing-first model. Clients, invoices, expenses, and balances brought into a full double-entry QuickBooks structure &mdash; with the chart of accounts built out properly rather than inferred from invoice categories." },
    { opener: "Wave to QuickBooks", body: "Moving off Wave for more capability or integrations. Customers, vendors, transactions, and opening balances migrated and verified in QuickBooks Online, with the bank feeds and rules rebuilt for the new file." },
    { opener: "Sage to QuickBooks", body: "Sage 50, Sage Business Cloud, or Sage Intacct to QuickBooks. Chart of accounts, lists, and balances mapped and reconciled across the structural differences between Sage&rsquo;s nominal-ledger model and QuickBooks." },
  ...
  faq: [
    ...
    { q: "Will my data be accurate after migrating to QuickBooks?", a: "That&rsquo;s the entire point of doing it with a ProAdvisor rather than a raw data import. The migration includes integrity verification &mdash; the balances, AR, AP, and key totals in QuickBooks are reconciled against the source system before sign-off, so the new file ties back to the numbers you had. A raw import or an unverified tool conversion is how businesses end up with wrong balances and untrustworthy books; the verification step is what prevents it. (Intuit itself recommends a ProAdvisor verify the data after any third-party conversion.)" },
  ],
  eleventyComputed: {
    pageGraph(data){
