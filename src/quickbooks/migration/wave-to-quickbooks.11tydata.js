...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a Wave migration?", a: "Yes — start with a free call, no obligation. A Certified ProAdvisor reviews your Wave file, confirms whether you&rsquo;ve genuinely outgrown it (if Wave still serves you well, we&rsquo;ll say so), and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-migration\">book the call</a>. Still deciding? The <a href=\"/quickbooks/compare/quickbooks-vs-wave/\">QuickBooks vs Wave comparison</a> walks through whether to switch at all." },
  ],
  eleventyComputed: {
    pageGraph(data){
