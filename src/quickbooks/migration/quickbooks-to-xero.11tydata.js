...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before deciding to switch?", a: "Yes — start with a free fit-assessment call, no obligation. A Certified ProAdvisor reviews your QuickBooks file, your accountant&rsquo;s preference, and the actual problem you&rsquo;re solving, then gives a plain recommendation: switch, stay, or fix the file. About a third of these calls end with us recommending you stay. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-migration\">book the call</a>. If the real issue is a broken file, a <a href=\"/quickbooks/cleanup/?intent=qb-cleanup\">QuickBooks file cleanup</a> is usually faster and cheaper than switching." },
