...
module.exports = {
  ...
  faq: [
    ...
    { q: "How long does it take to fix post-conversion balance errors?", a: "A focused fix typically completes in a few business days to a week once the diagnostic is done. A broader multi-account repair runs one to three weeks depending on the number of periods, accounts, and transactions involved. Because these errors block your ability to trust the books, we prioritize them &mdash; the diagnostic is usually scheduled within a day or two of you reaching out. To get yours scheduled, speak to a ProAdvisor at <a href=\"tel:+18777515575\">(877) 751-5575</a>." },
  ],
  eleventyComputed: {
    pageGraph(data){
