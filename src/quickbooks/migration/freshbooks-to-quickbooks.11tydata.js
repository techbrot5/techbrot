...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to the switch?", a: "Yes — start with a free call, no obligation. A Certified ProAdvisor reviews your FreshBooks account, confirms whether moving is genuinely worth it (if FreshBooks still serves you well, we&rsquo;ll say so), and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-migration\">book the call</a>. Still deciding? Our <a href=\"/quickbooks/compare/quickbooks-vs-freshbooks/\">QuickBooks vs FreshBooks comparison</a> covers the should-you-move question." },
