  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        ...
        {"@type":"DefinedTerm","@id":url+"#migration-integrity-protocol","name":"Migration Integrity Protocol","description":"TechBrot&rsquo;s method for migrating to QuickBooks: build the destination to setup standard, document source balances first, then reconcile the imported data against the source system before sign-off so the new file ties back to the original numbers.","inDefinedTermSet":{"@id":"https://techbrot.com/#glossary"}},
