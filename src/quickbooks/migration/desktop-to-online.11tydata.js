...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a migration?", a: "Yes — start with a free 30-minute migration diagnostic, no obligation. A Certified ProAdvisor reviews your Desktop file, flags what won&rsquo;t transfer, confirms whether you&rsquo;re genuinely better off moving now or staying on Desktop/Enterprise, and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-migration\">book the diagnostic</a>. If the Desktop file needs repair first, that&rsquo;s a <a href=\"/quickbooks/cleanup/?intent=qb-cleanup\">file cleanup</a> scoped before conversion." },
  ],
  eleventyComputed: {
    pageGraph(data){
