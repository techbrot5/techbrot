...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a Sage migration?", a: "Yes — start with a free call, no obligation. A Certified ProAdvisor confirms which Sage product you run, reviews its export options, recommends how much history to bring versus archive, and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-migration\">book the call</a>. Still weighing whether to leave Sage? The <a href=\"/quickbooks/compare/quickbooks-vs-sage/\">QuickBooks vs Sage comparison</a> covers the decision first." },
  ],
  eleventyComputed: {
    pageGraph(data){
