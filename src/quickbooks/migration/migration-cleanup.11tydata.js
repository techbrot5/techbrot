...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a cleanup?", a: "Yes — start with a no-obligation cleanup diagnostic. A Certified ProAdvisor compares your converted file against the original source, maps what came across wrong, and gives an honest clean-up-vs-re-migrate recommendation plus a written fixed-fee scope. Call (877) 751-5575 or <a href=\"/contact/?intent=quickbooks-migration\">book the diagnostic</a>. If only the numbers are off, the focused fix is <a href=\"/quickbooks/migration/balances-wrong-after-conversion/?intent=quickbooks-migration\">balances wrong after conversion</a>." },
