...
module.exports = {
  ...
  faq: [
    ...
    { q: "What does it cost to speak to a QuickBooks expert?", a: "The first conversation costs nothing: the discovery call and the file review are both free. If there&rsquo;s work to do, you get a written, fixed-fee scope &mdash; a focused diagnostic is typically $1,200&ndash;$3,000, and a full <a href=\"/accounting/bookkeeping/cleanup-bookkeeping/\">cleanup</a> runs $1,500&ndash;$15,000+ when the books are behind. Nothing is charged and nothing is touched in your file until you approve the scope." },
    ...
    { q: "Is this the same as your main &ldquo;speak to a QuickBooks expert&rdquo; page?", a: "This is the quick, honest entry point in our QuickBooks Help silo. If you want the fuller picture &mdash; what working with an independent Certified QuickBooks ProAdvisor actually looks like and how the work is scoped &mdash; see our main <a href=\"/quickbooks/speak-to-a-quickbooks-expert/\">speak to a QuickBooks expert</a> page. Both reach the same independent ProAdvisor team." },
  ],
  eleventyComputed: {
    pageGraph(data){
