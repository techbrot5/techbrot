...
module.exports = {
  ...
  faq: [
    ...
    { q: "How is Error 12002 related to the other 12000-series errors?", a: "The 12000-series are all internet-connection and update-timeout errors &mdash; QuickBooks couldn&rsquo;t reach the update or payroll server. Error 12002 is specifically a connection timeout. Codes such as <a href=\"/quickbooks/help/error-codes/12007/\">12007</a> and <a href=\"/quickbooks/help/error-codes/12029/\">12029</a> share the same diagnostic approach: confirm the connection, correct QuickBooks&rsquo; internet settings, then clear the firewall or proxy block." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#12002-in-brief-text"]}},
        ...
        {"@type":"TechArticle","@id":url+"#techarticle","headline":"QuickBooks Error 12002: Update Timeout Causes & Fixes","description":data.description,"about":{"@type":"SoftwareApplication","name":"QuickBooks Desktop","applicationCategory":"BusinessApplication","operatingSystem":"Microsoft Windows"},"author":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","proficiencyLevel":"Beginner","mainEntityOfPage":{"@id":url+"#webpage"}},
