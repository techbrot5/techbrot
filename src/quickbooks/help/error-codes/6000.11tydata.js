...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I fix QuickBooks Error 6000 myself?", a: "Often, yes &mdash; in this order: run QuickBooks Tool Hub (Quick Fix my File, then File Doctor); rename the .ND and .TLG files; copy the company file to the local drive and open it there; check hosting/multi-user configuration; check firewall and antivirus; <a href=\"/quickbooks/help/backup-restore/\">restore from a clean backup</a>. Tool Hub alone resolves many 6000-series errors." },
    ...
    { q: "When does Error 6000 require a ProAdvisor?", a: "When self-fix didn&rsquo;t resolve it; the error recurs; the <a href=\"/quickbooks/help/file-corrupted/\">company file is genuinely damaged</a>; or it appears with a specific suffix that won&rsquo;t clear. If the file won&rsquo;t open and recent work is at risk, stop retrying and reach a ProAdvisor directly at <a href=\"tel:+18777515575\">(877) 751-5575</a>. Typical focused resolution is a $1,200–$3,000 fixed-fee scope, after a free file review." },
