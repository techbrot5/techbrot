...
module.exports = {
  ...
  faq: [
    ...
    { q: "Is Error 9999 a QuickBooks Desktop company-file error?", a: "No. Error 9999 is a QuickBooks Online, browser-side script error &mdash; there is no Tool Hub, no File Doctor, and no .ND/.TLG company-file repair involved. The fix is browser troubleshooting (cache, cookies, extensions, browser version), not the Desktop file-repair process used for errors like the <a href=\"/quickbooks/help/error-codes/error-6000-series/\">6000-series</a>." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#9999-in-brief-text"]}},
        ...
        {"@type":"TechArticle","@id":url+"#techarticle","headline":"QuickBooks Online Error 9999: Causes & How to Fix It","description":data.description,"about":{"@type":"SoftwareApplication","name":"QuickBooks Online","applicationCategory":"BusinessApplication","operatingSystem":"Web browser"},"author":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","proficiencyLevel":"Beginner","mainEntityOfPage":{"@id":url+"#webpage"}},
