...
module.exports = {
  ...
  faq: [
    ...
    { q: "What&rsquo;s the difference between Error H101, H202, and H505?", a: "All three are multi-user errors with similar root causes. H101: the workstation can&rsquo;t establish the first connection to the server hosting the file. H202: the workstation can&rsquo;t connect to the host. H505: the workstation thinks the file is on a machine that isn&rsquo;t set up to host. The same diagnostic approach resolves all three." },
