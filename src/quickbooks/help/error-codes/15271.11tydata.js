...
module.exports = {
  ...
  faq: [
    ...
    { q: "How is Error 15271 related to the other 15000-series errors?", a: "The 15000-series are all update errors &mdash; QuickBooks couldn&rsquo;t download, validate, or install a payroll or software update. Error 15271 is specifically a file-validation failure tied to a damaged/incomplete download or a permission/UAC block. Codes such as 15223 and 12002 share the same diagnostic approach: fix permissions and the download path, then re-run the update." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#15271-in-brief-text"]}},
        ...
        {"@type":"TechArticle","@id":url+"#techarticle","headline":"QuickBooks Error 15271: Update Did Not Complete — Causes & Fixes","description":data.description,"about":{"@type":"SoftwareApplication","name":"QuickBooks Desktop","applicationCategory":"BusinessApplication","operatingSystem":"Microsoft Windows"},"author":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"inLanguage":"en-US","proficiencyLevel":"Beginner","mainEntityOfPage":{"@id":url+"#webpage"}},
