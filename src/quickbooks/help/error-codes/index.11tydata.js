...
module.exports = {
  ...
  sixThousand: [
    ...
    { name: "Error 6000-83", href: "/quickbooks/help/error-codes/6000-83/", body: "QuickBooks Desktop can&rsquo;t open or restore the company file &mdash; most often when the file sits on a server or network share, when restoring a backup, or when folder permissions are wrong. Full self-fix and HowTo on the dedicated page." },
    { name: "Error 6073, -816", href: "/quickbooks/help/error-codes/6073/", body: "The company file is locked or in use &mdash; open on another computer in single-user mode, opened by another user, hosted on multiple machines at once, or on a read-only or synced network location. Full self-fix and HowTo on the dedicated page." },
    { name: "Error 6150, -1006", href: "/quickbooks/help/error-codes/6150/", body: "QuickBooks can&rsquo;t open or create the company file &mdash; usually the .QBW file is damaged, is the wrong file type, or was quarantined by antivirus. Full self-fix and HowTo on the dedicated page." },
