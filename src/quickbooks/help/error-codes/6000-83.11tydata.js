...
module.exports = {
  ...
  faq: [
    ...
    { q: "Why does Error 6000, 83 happen when I restore a backup?", a: "Restoring a backup (.QBB) directly to a server or network drive frequently triggers Error 6000, 83. QuickBooks restores reliably to a local drive. Restore the file to a local drive first, confirm it opens cleanly, then move it to its shared network location." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#6000-83-in-brief-text"]}},
