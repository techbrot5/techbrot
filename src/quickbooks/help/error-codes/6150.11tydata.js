...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I fix QuickBooks Error 6150 myself?", a: "Often, yes &mdash; in this order: run QuickBooks Tool Hub (Quick Fix My File, then File Doctor); restore from a recent clean backup (.QBB) the correct way through File &rarr; Open or Restore Company; run a malware/antivirus scan and restore the file from quarantine; repair the QuickBooks installation; recreate the file if it was newly created. Tool Hub alone resolves Error 6150 in many cases." },
    { q: "When does Error 6150 require a ProAdvisor?", a: "When the company file is genuinely damaged; you have no clean backup to restore from; malware was involved; or self-fix didn&rsquo;t resolve it. Typical focused resolution or data recovery is a $1,200–$3,000 fixed-fee scope, after a free file review &mdash; call (877) 751-5575." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#6150-in-brief-text"]}},
