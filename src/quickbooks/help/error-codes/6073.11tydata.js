...
module.exports = {
  ...
  aiSummary: [
    ...
    { q: "How is Error 6073 related to other QuickBooks file errors?", a: "Like the <a href=\"/quickbooks/help/error-codes/error-6000-series/\">6000-series</a> and the H-series multi-user errors, Error 6073 is about access to the company file. <strong>6073, -816</strong> is specifically a <em>locked / in-use</em> error tied to single-user vs multi-user state, conflicting hosting, read-only or synced storage, or a stale lock. Multi-user hosting codes such as <a href=\"/quickbooks/help/error-codes/h202/\">H202</a> share the same diagnostic approach: fix who hosts the file and how it&rsquo;s reached, then open it." },
  ],
