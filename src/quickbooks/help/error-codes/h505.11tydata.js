...
module.exports = {
  ...
  faq: [
    ...
    { q: "What&rsquo;s the difference between Error H505 and Error H202?", a: "Both are multi-user errors with similar root causes. H505: the file is on another computer and this computer can&rsquo;t reach the server because hosting isn&rsquo;t configured. <a href=\"/quickbooks/help/error-codes/h202/\">H202</a>: the workstation can&rsquo;t connect to the host at all. <a href=\"/quickbooks/help/error-codes/h101/\">H101</a>: multi-user setup is incomplete on this machine. The same diagnostic approach resolves all three." },
