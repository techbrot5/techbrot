...
module.exports = {
  ...
  faq: [
    ...
    { q: "How is Error 15223 related to the other 15000-series errors?", a: "The 15000-series are all update &amp; maintenance-release errors &mdash; QuickBooks can&rsquo;t download or install a payroll or software update. Error 15223 is specifically tied to internet/Internet Explorer settings, digital-signature certificates, and SSL/browser security. Codes such as 15215, 15240, and 15271 share the same diagnostic approach: fix the connection and verification path first, then retry the update." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#15223-in-brief-text"]}},
        ...
        {"@type":"TechArticle","@id":url+"#techarticle","headline":"QuickBooks Error 15223: Update/Payroll Causes & Fixes","description":data.description,"about":{"@type":"SoftwareApplication","name":"QuickBooks Desktop","applicationCategory":"BusinessApplication","operatingSystem":"Microsoft Windows"},"author":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"inLanguage":"en-US","proficiencyLevel":"Beginner","mainEntityOfPage":{"@id":url+"#webpage"}},
