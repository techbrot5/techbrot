...
module.exports = {
  ...
  faq: [
    ...
    { q: "What&rsquo;s the difference between Error H202 and Error H505?", a: "Both are multi-user errors with similar root causes. H202: the workstation can&rsquo;t connect to the host. <a href=\"/quickbooks/help/error-codes/h505/\">H505</a>: the workstation thinks the file is on a different machine that isn&rsquo;t set up to host. <a href=\"/quickbooks/help/error-codes/h101/\">H101</a>: multi-user setup is incomplete on this machine. The same diagnostic approach resolves all three." },
