...
module.exports = {
  ...
  faq: [
    ...
    { q: "Does TechBrot support QuickBooks Desktop, Online, Enterprise, and Payroll?", a: "Yes — your work is handled by a Certified ProAdvisor across the full QuickBooks stack: Online (Level 2), Desktop, Enterprise, and Payroll. The same vetted operator network supports every product. Independent ProAdvisor firm, not affiliated with Intuit Inc." },
    ...
    { q: "Will my CPA accept the cleaned-up QuickBooks file?", a: "Yes. Cleanup engagements produce a CPA-ready file — reconciled to source documents, with documented adjustments. The deliverable is designed to be handed directly to a tax preparer or lender without rework. To start, book a free file diagnostic or call <a href=\"tel:+18777515575\">(877) 751-5575</a> to scope it." },
  ],
  eleventyComputed: {
    pageGraph(data){
