...
module.exports = {
  ...
  faq: [
    ...
    { q: "What is the difference between QuickBooks file cleanup and bookkeeping cleanup?", a: "QuickBooks file cleanup focuses on the file itself — bank feeds, reconciliation, corruption, multi-user, version conflicts. <a href=\"/accounting/bookkeeping/cleanup-bookkeeping/?intent=cleanup\">Bookkeeping cleanup</a> is broader — it reconstructs accurate financials from a messy state. Many engagements combine both, and they pair seamlessly." },
    { q: "Can I talk to a ProAdvisor before committing to a cleanup?", a: "Yes — and there's no obligation. A Certified ProAdvisor reviews where your file stands on a free discovery call, explains exactly what the cleanup involves, and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575, or start with a <a href=\"/quickbooks/file-review/?intent=file-review\">free file review</a>." },
    { q: "How is QuickBooks cleanup different from calling Intuit support?", a: "Intuit product support resolves software-level issues — installation, billing, account access. It does not perform bookkeeping work, reconciliation rebuilds, or data-integrity repairs that require judgment about your transactions. An independent Certified ProAdvisor does that work — cleanup, reconciliation, categorization, and ongoing operational support." },
  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"speakable":{"@type":"SpeakableSpecification","cssSelector":["#cleanup-in-brief-text"]}},
