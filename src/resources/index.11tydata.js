...
module.exports = {
  ...
  resourceGroups,
  relatedNote: "Looking for a specific term? Jump straight to the <a href=\"/glossary/\">glossary</a>. Want the numbers behind how small businesses really keep their books? See our <a href=\"/resources/research/\">research and data</a>. Curious how we name and diagnose the work? See the coined <a href=\"/frameworks/\">frameworks</a> we use to scope cleanup, catch-up, setup, and migration. And when you&rsquo;re ready for help with your own file, a <a href=\"/quickbooks/file-review/?intent=file-review\">free file review</a> shows exactly where setup or cleanup will help.",
  faq,
  eleventyComputed: {
    pageGraph(data){
