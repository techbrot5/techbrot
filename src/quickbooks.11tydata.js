...
module.exports = {
  ...
  products: [
    ...
    { name: "QuickBooks Desktop", body: "Locally installed, single-user or networked. Pro, <a href=\"/quickbooks/premier/\">Premier</a>, and Mac editions. Intuit is transitioning Desktop toward subscription-only and limited new sales.", best: "Businesses with established Desktop workflows. Most are now better served by migration to Online — we scope that honestly." },
  ...
  faq: [
    ...
    { q: "Which QuickBooks version is right for my business?", a: "It depends on your size, complexity, and how your team works. Most modern small businesses run best on cloud-based <a href=\"/quickbooks/online/\">QuickBooks Online</a>; established or industry-specific workflows sometimes still suit <a href=\"/quickbooks/desktop/\">QuickBooks Desktop</a>; and inventory-heavy or multi-entity operations may need Enterprise. As an independent ProAdvisor firm with no upsell incentive, we recommend the version that actually fits — and put it in writing before any work begins." },
    { q: "Can you fix my existing QuickBooks file?", a: "Yes — repairing existing files is the most common ProAdvisor engagement. Broken bank feeds, unreconciled accounts, duplicate transactions, version conflicts, and data-integrity errors get diagnosed and rebuilt to a clean, CPA-ready state inside your own file, with the audit trail visible to you. See <a href=\"/quickbooks/cleanup/\">QuickBooks cleanup</a> for scope and timelines, or call (877) 751-5575 to walk through what’s going wrong. Every cleanup is fixed-fee against a written scope agreed before work starts." },
    { q: "Do I need a ProAdvisor, or can I set up QuickBooks myself?", a: "You can set up QuickBooks yourself, and for a simple solo business that may be all you need. A Certified ProAdvisor earns its fee when the chart of accounts, bank and payroll integrations, sales-tax settings, and opening balances have to be right the first time — because correcting a misconfigured file later usually costs more than setting it up properly. See <a href=\"/quickbooks/setup/\">QuickBooks setup</a> if you’d rather start on a clean foundation." },
  ],
  eleventyComputed: {
    pageGraph(data){
