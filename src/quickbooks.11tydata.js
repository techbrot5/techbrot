...
module.exports = {
  ...
  engagements: [
    ...
    { num: "06", tag: "Reference", name: "ProAdvisor help center", body: "Independent ProAdvisor articles, error-code references, workflow guides, and best practices. Free reference library.", forWhom: "Self-service answers", timeline: "Articles & guides", price: "Free", href: "/contact/?intent=qb-help", cta: "Ask a ProAdvisor" },
  ],
  products: [
    ...
    { name: "QuickBooks Payroll", body: "Payroll integrated directly with QuickBooks Online or Desktop. Three tiers (Core, Premium, Elite) with tax filing and direct deposit included.", best: "Businesses with W-2 employees who want payroll inside QuickBooks. We also support Gusto, Rippling, and ADP when those fit better." },
  ],
  aiSummary: [
