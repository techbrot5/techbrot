...
module.exports = {
  ...
  faq: [
    ...
    { q: "What is job costing?", a: "Tracking revenue and cost to each individual job &mdash; labor, materials, subs, equipment, overhead &mdash; so each project produces its own P&amp;L. The discipline that lets a business answer &ldquo;did this job make money&rdquo; at close." },
    { q: "Who needs it?", a: "Construction GCs, subs, and trades most; also engineering, architecture, agencies, consultancies, law and accounting practices billing on matters, and small manufacturers running custom work. Anyone whose company-wide P&amp;L hides job-level truth." },
    { q: "How does it work in QuickBooks?", a: "Customers and sub-customers (or Projects in QBO), item-based transactions mapped to revenue and cost accounts, class or location for extra dimensions, and payroll integration for labor allocation. Set up correctly, every transaction lands against its job automatically." },
    { q: "What is WIP reporting?", a: "Work-in-progress: earned revenue versus billings on in-process jobs, with the variance recognized as over- or under-billing on the balance sheet. Essential for accurate financials, lender reporting, and bonding." },
    { q: "What does it cost?", a: "Setup inside a QuickBooks setup or cleanup engagement, scoped to the business. Ongoing job-costing bookkeeping included in monthly bookkeeping ($400&ndash;$2,500+/mo with complexity), priced higher for active job volume, AIA, or certified payroll. No hourly." },
  ],
