...
module.exports = {
  ...
  faq: [
    { q: "What does a controller do?", a: "A controller owns the accuracy, timeliness, and integrity of a company&rsquo;s financial records. The role manages the <a href=\"/accounting/month-end-close/\">month-end close</a>, oversees financial statement preparation, designs and operates internal controls, supervises bookkeeping staff or vendors, owns the reporting calendar, and ensures the numbers are right before they reach leadership, the board, or the CPA. Where a bookkeeper records transactions and a CFO sets strategy, the controller is accountable for the books being correct and on time." },
    { q: "What&rsquo;s the difference between a bookkeeper, a controller, and a CFO?", a: "A bookkeeper records and reconciles transactions &mdash; the operational layer. A controller manages and verifies the accounting function &mdash; owning the close, statement accuracy, and internal controls. A <a href=\"/accounting/advisory/fractional-cfo/\">CFO</a> sets financial strategy &mdash; forecasting, fundraising, board reporting, capital decisions. They form a ladder: the bookkeeper produces the data, the controller guarantees it&rsquo;s accurate and timely, the CFO interprets it and drives strategy. Smaller businesses often need only a bookkeeper; growth-stage businesses add a controller; complex or capital-raising businesses add a CFO on top." },
