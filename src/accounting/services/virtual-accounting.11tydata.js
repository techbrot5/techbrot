...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can virtual accounting work for any location?", a: "Yes. Because the work is cloud-based and fully remote, a business in any U.S. state can work with TechBrot the same way &mdash; there&rsquo;s no need for a local bookkeeper, and no disadvantage to being outside a major metro. This is especially valuable for remote-first companies, multi-location operations that would otherwise need bookkeeping in several places, and owners in areas with few qualified local accountants. Where state-specific matters arise, such as <a href=\"/accounting/sales-tax-compliance/\">sales-tax nexus</a>, we coordinate accordingly." },
