...
module.exports = {
  ...
  faq: [
    ...
    { q: "What is a chart of accounts?", a: "The complete list of every account used to record financial transactions &mdash; every category of revenue, expense, asset, liability, and equity. It defines the structure of the books and controls what reports can ever be produced." },
    { q: "Why does it matter?", a: "Because the chart of accounts is the reporting structure. Every report &mdash; P&amp;L, balance sheet, cash flow, KPI dashboard &mdash; inherits from it. Get it right once and the books work; get it wrong and every report fights against the structure forever." },
    { q: "Accounts vs classes vs locations?", a: "Accounts: what kind of money. Classes / Tags: whose money &mdash; which department, product line, project, segment. Locations: where the money is. Using all three together produces multi-dimensional reporting without exploding into thousands of redundant accounts." },
    { q: "Do I need a custom chart?", a: "Most businesses need an industry-appropriate one, not a fully custom one. QuickBooks default is generic. The right approach: proven industry template, adjusted to how your business operates &mdash; not the untouched default, and not a thousand-account custom no one maintains." },
    { q: "When restructure?", a: "When the business has changed since setup, reports don&rsquo;t answer what leadership asks, the chart has bloated through ad-hoc additions, or you&rsquo;re preparing for a sale, audit, fundraising, or new CPA. Fixed-fee project work, no hourly billing." },
  ],
  eleventyComputed: {
    pageGraph(data){
