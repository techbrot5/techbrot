  ...
  eleventyComputed: {
    pageGraph(data){
      ...
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"breadcrumb":{"@id":url+"#breadcrumb"},"inLanguage":"en-US","primaryImageOfPage":{"@type":"ImageObject","url":"https://techbrot.com/assets/og/cards/accounting-industries-nonprofit.png"},"speakable":{"@type":"SpeakableSpecification","cssSelector":["#acctind-nonprofit-definition","#acctind-nonprofit-ai-summary"]},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"}},
