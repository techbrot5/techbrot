...
module.exports = {
  ...
  faq: [
    ...
    { q: "My Shopify books are already a mess. Where do we start?", a: "With a cleanup. We untangle netted payouts, correct sales tax or gift cards that were booked as income, reconcile each channel to a known-good baseline, then transition into accurate monthly bookkeeping. This is a representative path, not a promised outcome &mdash; most Shopify sellers come to us mid-mess, and it is the normal starting point. See <a href=\"/pricing/\">pricing</a> for how scope is set, or call us at <a href=\"tel:+18777515575\">(877) 751-5575</a> to map your starting point." },
  ],
