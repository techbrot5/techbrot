...
module.exports = {
  ...
  faq: [
    ...
    { q: "Do you set up job costing in QuickBooks?", a: "Yes. We configure job costing in QuickBooks so labor, materials, equipment, and subcontractor costs are tracked to each project and cost code, giving you real job-level profitability instead of a company-wide guess." },
    ...
    { q: "Do you handle certified payroll and AIA billing?", a: "We support certified payroll reporting for prevailing-wage and public projects and AIA-style progress billing (G702/G703) workflows. Complex union or multi-state prevailing-wage situations are scoped on the discovery call." },
