...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can you track prime cost, food cost, and inventory?", a: "Yes. We track <a href=\"/glossary/cost-of-goods-sold/\">cost of goods sold</a> and labor to calculate prime cost as a percentage of sales, maintain inventory where needed, and break out food versus beverage cost so you can see margin by category and act on it. Prime cost is the single most important number in a restaurant P&amp;L." },
    { q: "Do you handle tips, payroll, and sales tax?", a: "We handle the bookkeeping for tip pooling and allocation, integrate <a href=\"/accounting/payroll-management/\">payroll</a> so tipped-wage and tip-credit entries post correctly, and track sales tax collected for remittance. TechBrot does not file income taxes and does not provide legal advice on labor or tip law; we coordinate with your CPA, EA, and payroll or labor counsel as needed." },
    { q: "Can you handle multiple locations?", a: "Yes. We track each location separately in QuickBooks, typically using Classes or location tracking, so you get a per-location profit and loss and prime cost alongside a consolidated view of the whole group &mdash; the same multi-unit structure that <a href=\"/accounting/industries/franchise/\">franchise groups</a> rely on." },
    { q: "What does restaurant bookkeeping cost?", a: "Pricing depends on number of locations, sales volume, POS and payroll complexity, and whether inventory and multi-location reporting are in scope. Restaurant engagements are quoted as a fixed monthly fee against a written scope with no hourly billing &mdash; call a ProAdvisor at <a href=\"tel:+18777515575\">(877) 751-5575</a> to scope your restaurant. TechBrot does not file income taxes; we coordinate with your CPA or EA." },
