...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can you produce monthly owner statements, owner draws, and 1099-MISC data?", a: "Yes. We produce monthly owner statements that reconcile to the bank, record owner draws against collected rent net of withheld management and leasing fees, and prepare year-end <a href=\"/accounting/1099-preparation/\">1099-MISC data</a> for each owner who received rent so it's ready for your CPA to file. TechBrot keeps the records and does not file income-tax returns." },
