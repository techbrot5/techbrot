...
module.exports = {
  ...
  faq: [
    ...
    { q: "Do you offer advice, or just bookkeeping?", a: "Both. Accurate, collection-based books come first; then a Certified ProAdvisor can turn them into decisions — provider and service-line profitability, payer-mix analysis, staffing against revenue, and cash-flow planning — through fractional CFO advisory. As automation handles routine data entry, this advisory layer is where the real value sits." },
  ],
