...
module.exports = {
  ...
  faq: [
    ...
    { q: "Do you handle IOLTA and client trust accounting?", a: "Yes. We maintain client trust and IOLTA accounting in QuickBooks with per-client ledgers, keep trust funds segregated from operating funds, and perform three-way reconciliation so the trust bank balance, the trust liability on the books, and the total of all client ledgers match. Responsibility for state bar trust rules and compliance certification remains with the firm and its attorneys; we maintain the records and reconciliation behind them." },
    { q: "What is three-way trust reconciliation?", a: "Three-way reconciliation confirms that three figures agree: the trust bank account balance, the trust liability recorded in the books, and the sum of every individual client&rsquo;s trust ledger balance. When all three match, no client&rsquo;s funds are overdrawn and trust money is not commingled with the firm&rsquo;s operating funds. Many state bars require it monthly." },
    ...
    { q: "Do you offer advice, or just bookkeeping?", a: "Both. Compliant trust accounting and accurate matter-level books come first; then a Certified ProAdvisor can turn them into decisions &mdash; practice-area profitability, partner compensation, realization and collection rates, and cash-flow planning &mdash; through fractional CFO advisory. As automation handles routine data entry, this advisory layer is where the real value sits." },
  ],
