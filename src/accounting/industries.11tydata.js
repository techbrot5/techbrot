...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can you handle inventory, job costing, or multi-entity books for my industry?", a: "Yes &mdash; those are exactly the mechanics generic bookkeeping tends to get wrong. We configure QuickBooks for inventory and COGS, job and project costing, class and location tracking, and multi-entity or multi-location rollups, matched to how your industry actually runs. If the existing setup needs heavier structure, we build it during onboarding or a <a href=\"/accounting/bookkeeping/cleanup-bookkeeping/\">cleanup</a>." },
    { q: "Do you handle multi-state sales tax for businesses in my industry?", a: "Yes. Many industries &mdash; e-commerce, retail, SaaS, and contractors working across state lines &mdash; trigger sales-tax obligations in several states once economic-nexus thresholds are crossed. We handle nexus review, registration, exemption certificates, and recurring filings as part of your books. See <a href=\"/accounting/sales-tax-compliance/\">sales tax compliance</a> for how it&rsquo;s scoped." },
    { q: "How quickly can you get my industry books up to date?", a: "It depends on how far behind and how complex the file is, but most catch-up and cleanup projects run a few weeks before you move into accurate <a href=\"/accounting/bookkeeping/monthly-bookkeeping/\">monthly bookkeeping</a>. We scope the timeline in writing before starting, so there are no surprises &mdash; call (877) 751-5575 for a free 30-minute discovery call and we&rsquo;ll estimate yours. Cleanups are fixed-fee against a written scope, never hourly." },
  ],
  eleventyComputed: {
    pageGraph(data){
