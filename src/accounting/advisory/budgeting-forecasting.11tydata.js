...
module.exports = {
  ...
  faq: [
    ...
    { q: "What is budget-vs-actual variance reporting?", a: "Each month, actual results from the <a href=\"/accounting/bookkeeping/monthly-bookkeeping/\">books</a> are compared to the budget for that month, with material variances explained: where the business is ahead or behind, by how much, and why. This is the report that turns the budget from a January exercise into a living management tool &mdash; and the basis for monthly reforecasting." },
