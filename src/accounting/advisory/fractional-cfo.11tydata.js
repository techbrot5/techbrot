...
module.exports = {
  ...
  faq: [
    ...
    { q: "What does a fractional CFO actually do?", a: "Six areas: <a href=\"/accounting/advisory/financial-strategy/\">financial strategy</a>, <a href=\"/accounting/advisory/cash-flow-management/\">cash flow & forecasting</a>, board & investor reporting, fundraising & capital, KPI & unit economics, and senior advisory & M&A. Not tax filing, not audit, not legal — those stay with the licensed professionals we coordinate with." },
    ...
    { q: "Is a fractional CFO available immediately?", a: "Engagements are accepted by application and limited per quarter to preserve senior attention. After a brief application and a 45-minute diagnostic call — book it online or call <a href=\"tel:+18777515575\">(877) 751-5575</a> — a written scope is produced within 5 business days, with engagement start typically about 2 weeks after scope acceptance." },
  ],
  eleventyComputed: {
    pageGraph(data){
