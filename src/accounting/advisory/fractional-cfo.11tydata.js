...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a senior operator before committing to an engagement?", a: "Yes — start with a 45-minute diagnostic call, no obligation. A senior operator assesses fit, scope, timing, and the right engagement match; if it's a fit, a written scope follows within 5 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=fractional-cfo\">request a diagnostic call</a> to begin. The first <a href=\"/accounting/bookkeeping/monthly-bookkeeping/?intent=monthly\">monthly bookkeeping</a> layer can run underneath so the CFO works from accurate books day one." },
  ],
  eleventyComputed: {
    pageGraph(data){
