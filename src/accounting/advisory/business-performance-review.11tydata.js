...
module.exports = {
  ...
  faq: [
    ...
    { q: "How is it different from KPI reporting or a P&amp;L?", a: "<a href=\"/accounting/advisory/kpi-reporting/\">KPI reporting</a> delivers the numbers; a performance review is the working session that turns those numbers into decisions. A P&amp;L is the financial statement; a review interprets it alongside KPIs, variance against budget, and trend lines. Reporting is the data; the review is what you do with it. The two work together &mdash; most clients have both." },
    ...
    { q: "What is a business performance review?", a: "A recurring, structured read of margin, segment profitability, KPI variance, and trends &mdash; turned into a short action list with named owners. The standing meeting that converts financial reports into decisions." },
    { q: "How is it different from KPI reporting?", a: "KPI reporting delivers the numbers; a review is the working session that turns them into decisions. Reporting is the data; the review is what you do with it. Most clients have both." },
    { q: "How often should we do it?", a: "Monthly is standard for active operations; quarterly for steadier or smaller businesses. Many clients pair both: brief monthly checks, longer quarterly strategic reviews." },
    { q: "Who runs the review?", a: "A named Certified ProAdvisor &mdash; preps materials, walks you through the read, documents the action list with owners and deadlines. The point is decisions and accountability, not a deck." },
    { q: "What does it cost?", a: "Usually added to a monthly bookkeeping or advisory engagement at a fixed monthly fee by scope. Intensive review and ongoing accountability is part of a fractional CFO engagement ($3,000&ndash;$8,000+/mo, by application). No hourly billing." },
  ],
  eleventyComputed: {
    pageGraph(data){
