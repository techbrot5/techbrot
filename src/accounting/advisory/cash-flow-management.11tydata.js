...
module.exports = {
  ...
  faq: [
    ...
    { q: "Is cash flow management the same as bookkeeping?", a: "No. Bookkeeping records what already happened. Cash flow management is forward-looking &mdash; it forecasts what will happen and helps you change it. It&rsquo;s an <a href=\"/accounting/advisory/\">advisory</a> service built on top of <a href=\"/accounting/bookkeeping/monthly-bookkeeping/\">accurate books</a>: the forecast is only as reliable as the bookkeeping underneath it, which is why we start there if the books need work." },
