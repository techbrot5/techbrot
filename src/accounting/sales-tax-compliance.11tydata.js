...
module.exports = {
  ...
  faq: [
    ...
    { q: "What does sales tax compliance management include?", a: "Multi-state filings on each state’s schedule, remittance, economic-nexus threshold monitoring, marketplace-facilitator reconciliation, QuickBooks and e-commerce platform integration, state-notice response, basic exemption-certificate management, rate-update monitoring, a monthly compliance summary, a named operator, and an annual nexus review. Nexus analysis, registrations, VDAs, and audit support are layered on as scope requires." },
    { q: "What if I should have been collecting sales tax but haven’t been?", a: "A common situation. For limited exposure: register and start complying going forward. For larger exposure: Voluntary Disclosure Agreement (VDA) programs with each affected state typically reduce penalties and limit lookback in exchange for proactive registration and back-tax payment. We coordinate with state-specific sales-tax counsel when VDAs or back-tax negotiation are required." },
    { q: "Do you handle sales tax audits?", a: "We provide operational audit support — documentation, transaction records, reconciliations, and exemption-certificate files. For audits with significant exposure or tax-position disputes, we coordinate with state-specific sales-tax counsel or CPAs. TechBrot’s role is operational compliance and documentation; legal representation and tax-position defense run through licensed professionals." },
  ],
  eleventyComputed: {
    pageGraph(data){
      const url="https://techbrot.com/accounting/sales-tax-compliance/";
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#sales-tax-compliance-in-brief-text"]}},
