...
module.exports = {
  ...
  faq: [
    ...
    { q: "What are the three main financial statements?", a: "The income statement (P&amp;L), balance sheet, and cash flow statement. P&amp;L shows performance over a period; balance sheet shows financial position at a point in time; cash flow reconciles profit to actual cash." },
    { q: "P&amp;L vs cash flow statement?", a: "P&amp;L reports income and expense when earned and incurred; cash flow reports actual cash in and out. A business can be profitable while losing cash &mdash; the cash flow statement explains that gap." },
    { q: "What is the balance sheet?", a: "A snapshot at a single moment: assets (what the business owns), liabilities (what it owes), and equity. Assets equal liabilities plus equity, always. Shows financial health and structure, not just performance." },
    { q: "Are TechBrot statements GAAP audit-ready?", a: "We prepare internal management and CPA-ready statements &mdash; reconciled and structured so your CPA can file from them or perform a formal compilation, review, or audit on top. We don&rsquo;t provide audit, review, or compilation ourselves &mdash; those are licensed CPA engagements." },
    { q: "How often should they be produced?", a: "Monthly is standard. Annual-only is almost always too infrequent &mdash; you find out in March how December went. Included in monthly bookkeeping engagements ($400&ndash;$2,500+/mo)." },
  ],
