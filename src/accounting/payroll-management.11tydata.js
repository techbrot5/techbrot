...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I switch from my current payroll provider?", a: "Yes. Provider switches are routine. We handle YTD migration, prior-filings reconciliation, state-account transitions, direct-deposit migration, and employee notification. Most transitions complete in 2–4 weeks, and we time them to avoid breaking your filing history. To scope a switch, book a free call or dial <a href=\"tel:+18777515575\">(877) 751-5575</a>." },
    { q: "What’s the difference between payroll software and payroll management?", a: "Payroll software is the tool that runs the calculations; payroll management is a professional operating the tool correctly — verifying data, reviewing for anomalies, filing on schedule, handling state notices, and reconciling to your books. Software still requires someone to run it right; management is that someone." },
    { q: "How does TechBrot payroll integrate with bookkeeping?", a: "When one firm runs both, the payroll journal posts directly into your QuickBooks file each cycle and liabilities reconcile automatically — eliminating the reconciliation gaps that appear when payroll and bookkeeping run with separate providers. Pairing payroll with <a href=\"/accounting/bookkeeping/monthly-bookkeeping/?intent=monthly\">monthly bookkeeping</a> also costs materially less than two separate vendors." },
  ],
  eleventyComputed: {
    pageGraph(data){
