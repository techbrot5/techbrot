...
module.exports = {
  ...
  faq: [
    ...
    { q: "How does TechBrot payroll integrate with bookkeeping?", a: "When TechBrot runs both, the payroll journal posts directly into your QuickBooks file each cycle and liabilities reconcile automatically — eliminating the reconciliation gaps that appear when payroll and bookkeeping run with separate providers. The combined engagement also costs materially less than two separate vendors." },
  ],
  eleventyComputed: {
    pageGraph(data){
      const url="https://techbrot.com/accounting/payroll-management/";
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":data.title,"description":data.description,"isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"inLanguage":"en-US","speakable":{"@type":"SpeakableSpecification","cssSelector":["#payroll-management-in-brief-text"]}},
