...
module.exports = {
  ...
  faq: [
    ...
    { q: "What is account reconciliation?", a: "Confirming an account&rsquo;s book balance matches its source &mdash; bank or credit card statement, loan schedule, payroll filing, processor report. When they agree, reconciled; when they don&rsquo;t, the difference is investigated. It&rsquo;s the step that proves the books are real." },
    { q: "Why is bank reconciliation important?", a: "It&rsquo;s the single most important verification in bookkeeping. Without it, missing, duplicate, or miscategorized transactions persist undetected, distorting every downstream report &mdash; financial statements, tax returns, lender packages. Reconciled is the minimum standard for treating books as accurate." },
    { q: "What accounts should be reconciled?", a: "Every bank, credit card, loan, line of credit, and merchant processor, plus balance-sheet accounts: payroll liabilities to filings, deposits held, prepaids, intercompany &mdash; any account whose book balance should match a verifiable external figure." },
    { q: "How often?", a: "Monthly, as part of month-end close, on a published calendar. Year-end-only means errors compound for twelve months &mdash; far more expensive to fix than catching them in the month they happen." },
    { q: "What if I&rsquo;m months behind?", a: "Catch-up if transactions are recorded but never reconciled; cleanup if the file itself is broken. Fixed-fee project work; then transition into recurring monthly close." },
  ],
  eleventyComputed: {
    pageGraph(data){
