...
module.exports = {
  ...
  "override:faq": [
    ...
    { q: "Can I catch up my books before tax season?", a: "Yes. Pre-tax-season catch-up is one of the most common engagements. Book a discovery call by early February for most single-year catch-ups to complete in time for March 15 or April 15 deadlines. Multi-year catch-ups may require an extension." },
    { q: "Do I need to catch up before switching to monthly bookkeeping?", a: "Yes. Monthly bookkeeping starts from a known-current state. Catch-up brings your books to that state. Most clients transition directly from catch-up to monthly with the same operator." },
    { q: "Can I talk to a ProAdvisor before committing to a catch-up?", a: "Yes — start with a free 30-minute diagnostic call, no obligation. An independent Certified ProAdvisor quantifies the backlog, explains exactly what the catch-up covers, and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=catch-up\">book the diagnostic</a>. If the books are also messy or wrong, ask about <a href=\"/accounting/bookkeeping/cleanup-bookkeeping/?intent=cleanup\">cleanup bookkeeping</a> on the same call." },
  ],
  eleventyComputed: {
    pageGraph(data){
