...
module.exports = {
  ...
  "override:faq": [
    ...
    { q: "How much does bookkeeping cleanup cost?", a: "Cleanup is priced by scope, not by hour. Small single-year cleanups typically range from $1,500 to $3,500. Standard 12 to 24 month cleanups fall between $3,500 and $8,000. Multi-year cleanups involving payroll, inventory, or multi-entity structures typically range from $8,000 to $15,000 or more. Every cleanup engagement is fixed-fee against a written scope — for a quote, book a free diagnostic or call <a href=\"tel:+18777515575\">(877) 751-5575</a>." },
    ...
    { q: "What is the difference between cleanup and catch-up bookkeeping?", a: "<a href=\"/accounting/bookkeeping/catch-up-bookkeeping/?intent=catch-up\">Catch-up bookkeeping</a> brings behind-but-structured books up to date — entering missed transactions, completing reconciliations through the current month. Cleanup is a deeper engagement that corrects errors, fixes categorization, resolves reconciliation discrepancies, and reconstructs accurate records from a messy or unreliable state. Many engagements include both." },
