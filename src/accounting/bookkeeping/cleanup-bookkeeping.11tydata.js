...
module.exports = {
  ...
  "override:faq": [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a cleanup?", a: "Yes — start with a free 30-minute diagnostic call, no obligation. An independent Certified ProAdvisor reviews your file and statements, explains what the cleanup involves, and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=cleanup\">book the diagnostic</a>. Once the books are clean, the same named operator can continue with <a href=\"/accounting/bookkeeping/monthly-bookkeeping/?intent=monthly\">monthly bookkeeping</a>." },
