...
module.exports = {
  ...
  "override:faq": [
    ...
    { q: "Can I talk to a ProAdvisor before signing up for monthly bookkeeping?", a: "Yes — start with a free discovery call, no obligation. An independent Certified ProAdvisor confirms the right tier, walks through what each monthly close includes, and quotes a fixed monthly fee in writing before anything begins. Call (877) 751-5575 or <a href=\"/contact/?intent=monthly\">book the call</a>. If the books need work first, the same operator can run <a href=\"/accounting/bookkeeping/cleanup-bookkeeping/?intent=cleanup\">cleanup</a> or catch-up, then transition to monthly." },
