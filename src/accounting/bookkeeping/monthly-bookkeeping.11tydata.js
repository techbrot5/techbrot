...
module.exports = {
  ...
  "override:faq": [
    ...
    { q: "How much does monthly bookkeeping cost?", a: "Pricing depends on transaction volume, account count, payroll, sales tax, and entity complexity. Typical: $400–$700/mo Essentials, $700–$1,400/mo Standard, $1,400–$2,500+/mo Complex. Every engagement is a fixed monthly fee against a written scope — no hourly billing. For a quote, book a free call or dial <a href=\"tel:+18777515575\">(877) 751-5575</a>." },
    ...
    { q: "Do I need to clean up my books before starting monthly bookkeeping?", a: "Monthly bookkeeping starts from a known-current state. Behind books need <a href=\"/accounting/bookkeeping/catch-up-bookkeeping/?intent=catch-up\">catch-up</a> first; messy or inaccurate books need <a href=\"/accounting/bookkeeping/cleanup-bookkeeping/?intent=cleanup\">cleanup</a> first. Most clients transition directly from cleanup or catch-up to monthly with the same operator." },
