...
faqHeading: "W-2 vs 1099, answered."
faq:
  - q: "What's the difference between a W-2 employee and a 1099 contractor?"
    a: "A W-2 employee works under your direction and control; you withhold income and payroll taxes, pay the employer share, and provide a W-2. A 1099 contractor is an independent business you pay for a result; they control how the work is done, handle their own taxes, and get a 1099-NEC. The label follows the actual working relationship, not what you call it."
  - q: "How does the IRS decide if someone is an employee or contractor?"
    a: "It weighs the overall relationship across three areas: behavioral control (do you direct how, when, and where they work?), financial control (do they have their own investment, profit/loss risk, and other clients?), and the type of relationship (ongoing, with benefits, doing core work?). No single factor decides it — it&rsquo;s the whole picture. Some states use stricter tests like the ABC test."
  - q: "What happens if I misclassify an employee as a contractor?"
    a: "You can be liable for back payroll taxes (both shares), unpaid overtime, penalties, and interest, plus potential state penalties — and it&rsquo;s the business, not the worker, who pays. Misclassification is a common audit target. If you&rsquo;re unsure, it&rsquo;s far cheaper to get it right up front than to be reclassified later."
  - q: "Can the same person be both?"
    a: "Not for the same work at the same time. A worker is either an employee or a contractor for a given role based on the relationship. Someone could be your W-2 employee and separately do unrelated contract work for you, but you can&rsquo;t pay the same job partly on payroll and partly on a 1099 to split the difference."
  - q: "How can TechBrot help?"
    a: "We run payroll and keep contractor records clean — collecting W-9s, tracking payments, and filing W-2s and 1099-NECs on time — and we&rsquo;ll flag classification questions we see in your books. For a formal classification determination or a dispute, that&rsquo;s a question for your CPA or an employment attorney; we make sure the records support whatever the right answer is."
  - q: "What is the ABC test?"
    a: "A stricter classification standard used by several states: a worker is presumed to be an employee unless the business proves all three prongs — (A) the worker is free from the company&rsquo;s control, (B) the work is outside the company&rsquo;s usual business, and (C) the worker is independently established in that trade. It&rsquo;s a higher bar than the federal test, so a worker can be a contractor federally but an employee under state law. Check your state&rsquo;s rule."
ctaBand:
  eyebrow: "Payroll and 1099s handled right"
  heading: "Keep your workers classified and filed correctly."
  lede: "A free 30-minute discovery call scopes ongoing payroll and contractor record-keeping &mdash; W-9s collected, payments tracked, W-2s and 1099s filed on time. We coordinate classification questions with your CPA. Written fixed-fee scope, no obligation."
  actions:
    - label: "Book the discovery call"
      href: "/contact/?intent=payroll"
      class: "btn--primary"
    - label: "Speak to a ProAdvisor"
      tel: true
      class: "btn--ghost"
relatedPosts:
  - name: "Get your books ready for tax season"
    body: "Clean contractor records are half the battle. Here&rsquo;s the rest of tax-season prep."
    href: "/blog/get-your-books-ready-for-tax-season/"
  - name: "Bookkeeping vs accounting"
    body: "Where payroll record-keeping ends and your CPA&rsquo;s filing begins."
    href: "/blog/bookkeeping-vs-accounting/"
  - name: "5 signs your books need a cleanup"
    body: "Misclassified payments are one of the messes a cleanup untangles."
...
- **File on time.** 1099-NEC and W-2 are both due January 31 — our [1099 deadline calculator](/tools/1099-deadline-calculator/) gives you the exact date for any year.
- **When it's genuinely close, get a determination** from your CPA or an attorney. Cheaper than being reclassified later.

Where we fit: we [run payroll](/accounting/payroll-management/) and keep the contractor and employee records clean and filed on time, and we'll flag classification questions we spot in your books. The formal call on a borderline worker is your CPA's or attorney's — our job is making sure the records back up the right answer.
