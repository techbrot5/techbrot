...
module.exports = {
  ...
  faq: [
    { q: "How much does a fractional CFO cost per month?", a: "A TechBrot fractional CFO is a fixed monthly retainer of <strong>" + CFO_RANGE + "/month</strong> &mdash; not hourly. The retainer is scoped per engagement after a free discovery call, and the exact number is confirmed in writing before you commit. Engagements are accepted by application, with limited capacity each quarter." },
    ...
    { q: "How do I get an exact fractional CFO quote?", a: "Start with a free 30-minute discovery call. If the fit is right and capacity allows, TechBrot delivers a written retainer scope &mdash; the exact monthly number, the cadence, and the deliverables &mdash; before you commit to anything. Because engagements are by application, the call also confirms whether a fractional CFO is the right next step for your business at all." },
