...
module.exports = {
  ...
  faq: [
    ...
    { q: "Is this single-product break-even?", a: "Yes. It models one price and one variable cost. If you sell a mix of products at different margins, the real break-even depends on your sales mix, which this simple tool can&rsquo;t capture. A fractional CFO can build a weighted, multi-product model for you." },
    ...
    { q: "How can TechBrot help beyond the calculator?", a: "We keep your books accurate so the inputs to a calculation like this are real, and our fractional CFO engagement builds full unit-economics, budgeting, and cash-flow models on top of clean data. Book a free discovery call to talk it through." },
