...
module.exports = {
  ...
  faq: [
    { q: "Is this estimator a real quote?", a: "No &mdash; and we&rsquo;re explicit about it. It&rsquo;s an estimate drawn from TechBrot&rsquo;s published cleanup ($1,500&ndash;$15,000+) and catch-up ($2,000&ndash;$20,000+) pricing, meant to put you in a realistic range. Cleanup cost depends on what we find inside the file, so the exact fixed fee is quoted in writing within 3 business days of a free discovery call." },
    ...
    { q: "Is cleanup a one-time cost or monthly?", a: "One-time. Cleanup and catch-up are fixed-fee projects with defined start and completion dates. Once your books are current and correct, ongoing monthly bookkeeping ($400&ndash;$2,500+/month) takes over &mdash; that&rsquo;s a separate recurring engagement." },
