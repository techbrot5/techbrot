...
module.exports = {
  ...
  faq: [
    ...
    { q: "What if I&rsquo;m between two plans?", a: "Pick based on the feature you actually need now, not the one you might use someday &mdash; you can upgrade in minutes as the business grows, without losing data. If you&rsquo;re genuinely unsure, a Certified ProAdvisor can look at how you work and <a href=\"/quickbooks/which-plan-is-right/\">confirm the tier</a>, often saving you from over-buying." },
    { q: "Do plan features ever change?", a: "Yes &mdash; Intuit periodically revises what&rsquo;s included in each tier and adjusts user limits. This selector reflects the current <a href=\"/quickbooks/online/\">QuickBooks Online</a> lineup at a feature level, but always verify the specifics with Intuit, and we keep the tool updated as the lineup changes." },
    { q: "Is QuickBooks Online the only option you recommend?", a: "No. We&rsquo;re Certified ProAdvisors and QuickBooks is what we know best, but we advise on fit first &mdash; if <a href=\"/quickbooks/compare/\">a different platform</a> genuinely suits your business better, we&rsquo;ll say so. The discovery call is about what&rsquo;s right for you, not steering you to one product." },
