...
module.exports = {
  ...
  faq: [
    ...
    { q: "How detailed should my expense buckets be?", a: "For a quick monthly check, three buckets &mdash; cost of goods, fixed, and other/variable &mdash; are enough to see whether the month works. A working budget breaks those into real categories that match your <a href=\"/accounting/chart-of-accounts-setup/\">chart of accounts</a>, so you can track each line against actuals. That fuller structure is part of a budgeting engagement." },
    { q: "How is this different from a forecast?", a: "A budget is your plan for a period; a forecast is your best current estimate of how the period will actually turn out, updated as real numbers come in. This worksheet is a single-month budget snapshot. Rolling it forward and tracking against actuals is forecasting &mdash; which a <a href=\"/accounting/advisory/fractional-cfo/\">fractional CFO</a> or advisory engagement provides." },
    { q: "How can TechBrot help beyond the worksheet?", a: "We keep your books accurate so your budget buckets are real, and our <a href=\"/accounting/advisory/budgeting-forecasting/\">budgeting-and-forecasting</a> and fractional CFO engagements build full, tracked budgets and forward forecasts. Book a free discovery call to talk it through." },
