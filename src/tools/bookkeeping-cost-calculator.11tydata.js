...
module.exports = {
  ...
  faq: [
    { q: "Is this calculator a real quote?", a: "No &mdash; and we&rsquo;re explicit about that. It&rsquo;s an estimate drawn from TechBrot&rsquo;s published $400&ndash;$2,500+/month <a href=\"/pricing/bookkeeping/\">monthly-bookkeeping pricing</a>, meant to put you in a realistic range. A five-question form can&rsquo;t see your actual QuickBooks file, so it can&rsquo;t produce an exact fee. Your real fixed fee is quoted in writing within 3 business days of a free discovery call." },
    ...
    { q: "What if my books are behind?", a: "Then the monthly fee isn&rsquo;t your first question. Catching up or cleaning up historical books is separate one-time work &mdash; <a href=\"/accounting/bookkeeping/cleanup-bookkeeping/\">cleanup</a> runs $1,500&ndash;$15,000+ and <a href=\"/accounting/bookkeeping/catch-up-bookkeeping/\">catch-up</a> $2,000&ndash;$20,000+, priced on how far behind you are and the severity of the issues. Once the books are current, the monthly fee this tool estimates takes over." },
