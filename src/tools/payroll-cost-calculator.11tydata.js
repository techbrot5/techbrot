...
module.exports = {
  ...
  faq: [
    { q: "Does this estimate include wages and payroll taxes?", a: "No &mdash; and that&rsquo;s an important distinction. This estimates only TechBrot&rsquo;s <strong>management fee</strong> ($150&ndash;$800+/month) to <a href=\"/accounting/payroll-management/\">run your payroll</a>. Your employees&rsquo; wages and your payroll tax liabilities are separate costs that depend entirely on what you pay your people; we don&rsquo;t and can&rsquo;t estimate those from a four-question form." },
    ...
    { q: "Why does multi-state payroll cost more?", a: "Every state you run payroll in adds its own registration, tax filing, and compliance obligations &mdash; and the rules differ by state. <a href=\"/quickbooks/payroll/multi-state/\">Multi-state</a> is the single biggest driver of the management fee, which is why the calculator weights it heavily. A single-state team is far simpler to run than the same headcount split across four states." },
    ...
    { q: "Can payroll be bundled with bookkeeping?", a: "Yes &mdash; many clients have TechBrot run both, and the engagements are scoped together so the books and payroll stay in sync. You can estimate the <a href=\"/accounting/bookkeeping/monthly-bookkeeping/\">monthly bookkeeping</a> fee separately with the bookkeeping cost calculator; the discovery call scopes the combined engagement in writing." },
