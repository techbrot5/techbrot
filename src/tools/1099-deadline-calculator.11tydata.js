...
module.exports = {
  ...
  faq: [
    ...
    { q: "When should I send the W-9 and collect contractor info?", a: "Before you pay a contractor &mdash; not in January. Collecting a signed <a href=\"/glossary/w-9-form/\">W-9</a> up front means you have the legal name, TIN, and address ready when <a href=\"/glossary/1099-nec/\">1099-NEC</a> season arrives, and you avoid backup-withholding headaches. Keeping that current through the year is part of good bookkeeping." },
    { q: "What if I already missed the deadline?", a: "File as soon as possible &mdash; penalties scale with how late you are, so a few weeks late is far cheaper than months. Get the correct forms out to recipients and the IRS, and talk to your CPA about any penalty relief. We can help <a href=\"/accounting/1099-preparation/\">reconstruct accurate contractor records</a> if your books are behind." },
