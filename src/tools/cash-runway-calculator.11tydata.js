...
module.exports = {
  ...
  faq: [
    ...
    { q: "How can TechBrot help beyond the number?", a: "We keep your books accurate so burn and cash are real figures, and our cash-flow and fractional CFO engagements build forward forecasts that show runway changing over time. Book a free discovery call to talk it through." },
