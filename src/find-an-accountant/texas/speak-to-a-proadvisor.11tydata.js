/* /find-an-accountant/texas/speak-to-a-proadvisor/ — TX HONEST-TRIAGE (money cluster BOFU).
 * t-bofu. Bespoke body (speak-to-a-proadvisor.njk). APPROVED CA pattern (founder sign-off 2026-06-18),
 * localized to Texas: not-Intuit boundary is the #1 gate; "Certified QuickBooks ProAdvisor" = a held
 * certification, not affiliation; Intuit account/billing/login intent routed AWAY to Intuit; we do the
 * books, the CPA files; TX agencies = the Texas Comptroller (no FTB/CDTFA/EDD). Founder-name-zero. */
const { stripTags, buildCityGraph } = require("../../../_build/lib/city-child.js");
module.exports = {
  cityMeta: {
    url: "https://techbrot.com/find-an-accountant/texas/speak-to-a-proadvisor/",
    name: "Speak to a Texas QuickBooks ProAdvisor",
    description: "Speak to a Certified QuickBooks ProAdvisor at TechBrot — an independent firm, not Intuit or QuickBooks support. A free, no-obligation call about your Texas books. Independent firm; does not file Texas taxes.",
    serviceName: "Texas QuickBooks ProAdvisor Discovery Call",
    serviceType: "QuickBooks ProAdvisor advisory and discovery call",
    serviceDesc: "A free, no-obligation discovery call with a Certified QuickBooks ProAdvisor for Texas businesses — reviewing the client's own QuickBooks file and recommending setup, cleanup, monthly management, or advisory. Independent firm, not Intuit or QuickBooks product support; does not provide Intuit account/billing support or file Texas tax returns — coordinates with the client's CPA or EA.",
    areaServed: [{ type: "State", name: "Texas", sameAs: "https://en.wikipedia.org/wiki/Texas" }],
    audienceType: "Texas businesses wanting to speak with an independent Certified QuickBooks ProAdvisor about their own books",
    offerPrice: "0",
  },
  summary: [
    "<strong>Speaking to a TechBrot ProAdvisor is a free, no-obligation call with an actual Certified QuickBooks ProAdvisor</strong> who works with Texas businesses &mdash; not a salesperson, not a call center, and not Intuit. We review your own QuickBooks file, answer your questions, and tell you honestly what you need: setup, cleanup, monthly bookkeeping, or advisory.",
    "One boundary up front, so no one wastes a call: this is <strong>not Intuit and not QuickBooks product support</strong>. &ldquo;Certified QuickBooks ProAdvisor&rdquo; is a certification this firm holds from Intuit; it doesn&rsquo;t mean Intuit affiliation. For an Intuit account, billing, subscription, or login problem, contact Intuit directly &mdash; we can&rsquo;t access your Intuit account. And for filing Texas tax returns or representing you before the Texas Comptroller, that&rsquo;s your CPA or EA. What we do is the accounting work inside your own books.",
  ],
  split: [
    { tag: "Call us", title: "Talk to a ProAdvisor if&hellip;", body: "Your call is about how your own books and QuickBooks file are set up and run. A Certified ProAdvisor can help with:", list: [
      ...
      "You have Texas-specific questions (8.25% sales tax by location, the franchise/margin tax, business personal property)",
      "You want CFO-level advisory once the books are clean",
    ], cta: "Book the discovery call &rarr;", href: "/contact/?intent=texas&state=texas&source_type=state-money&funnel_stage=BOFU" },
  ...
  aiSummary: [
    ...
    { q: "What does speaking to a Texas ProAdvisor cost?", a: "<strong>Nothing.</strong> The discovery call is free and no-obligation. You speak with an actual Certified QuickBooks ProAdvisor about your own Texas books; if you want work done, you get a written fixed-fee scope within 3 business days." },
    { q: "What can a ProAdvisor call help with?", a: "The accounting work inside your own books &mdash; QuickBooks setup, cleanup, catch-up, monthly bookkeeping, Texas specifics (8.25% sales tax by location, the franchise/margin tax, business personal property), and CFO-level advisory. We do the books; your CPA files." },
    { q: "What can&rsquo;t this call help with?", a: "Intuit account, billing, subscription, or login issues, and QuickBooks product bugs &mdash; those require Intuit, which we can&rsquo;t access. And filing Texas returns or representation before the Texas Comptroller is your CPA&rsquo;s or EA&rsquo;s." },
  ...
  conversation: [
    { num: "01", title: "You describe the situation", body: "Where your Texas books stand, what&rsquo;s prompting the call, and any deadline. No script, no qualifying interrogation." },
    { num: "02", title: "We review your own file", body: "A Certified ProAdvisor looks at your actual QuickBooks file &mdash; reconciliation, sales tax by location, the margin-tax figures &mdash; and tells you what it really needs." },
  ...
  faq: [
    ...
    { q: "What does the call cost, and is there an obligation?", a: "The discovery call is free and carries no obligation. You speak with an actual Certified QuickBooks ProAdvisor about your own Texas books. If you decide you want work done, you receive a written fixed-fee scope within 3 business days &mdash; but there&rsquo;s no pressure and no sales script." },
    ...
    { q: "What Texas things can a ProAdvisor actually help with?", a: "The accounting inside your books: QuickBooks setup and cleanup, monthly bookkeeping, 8.25% sales tax configured by location, the franchise (margin) tax position tracked, business personal property kept ready to render, and CFO-level advisory once the books are clean. We keep the books CPA-ready; your CPA files the Texas returns." },
    ...
    { q: "Do you file my Texas taxes?", a: "No. TechBrot is an independent Certified QuickBooks ProAdvisor firm &mdash; we do the bookkeeping and QuickBooks work and keep the books CPA-ready, and your CPA or EA files the franchise (margin) tax and sales tax and represents you before the Texas Comptroller. We are not affiliated with Intuit Inc." },
    { q: "Do you serve my Texas city or county?", a: "All 254 Texas counties, delivered remotely on QuickBooks &mdash; Houston, Dallas, Austin, San Antonio, Fort Worth, El Paso and beyond. Your location changes the sales-tax rate but not the service or the named ProAdvisor on your file." },
