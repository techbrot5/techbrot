...
module.exports = {
  ...
  value: [
    ...
    { num: "04", title: "Cleanup of a misconfigured file", body: "A common fix: sales tax was set to one statewide rate or mapped wrong. We correct it and reconcile back.", href: "/quickbooks/cleanup/", cta: "QuickBooks cleanup &rarr;" },
