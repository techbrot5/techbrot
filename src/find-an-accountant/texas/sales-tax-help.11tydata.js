/* /find-an-accountant/texas/sales-tax-help/ â€” TX SERVICE CHILD (tax cluster, non-triage).
 * t-bofu Â· partials/state-service-body.njk. TX sales & use tax. HONESTY: we configure and
...
module.exports = {
  ...
  callBar: true,
  heroFigure: "taccount",
  title: "Texas Sales Tax Help in QuickBooks Â· TechBrot",
  description: "Texas sales tax set up right in QuickBooks â€” 8.25% combined rate by location, reconciled so the Comptroller return ties. We configure; your CPA files. Fixed-fee, all 254 counties. Call (877) 751-5575.",
  breadcrumb: [
    { name: "Home", href: "/" },
  ...
  cityMeta: {
    ...
    description: "Texas sales tax configured and reconciled in QuickBooks â€” the 8.25% combined rate by location, items mapped, liability reconciled so the Comptroller return ties. We configure; your CPA confirms taxability and files. Independent firm; does not file returns or make nexus determinations.",
    ...
    audienceType: "Texas businesses that collect sales tax â€” retail, e-commerce, restaurants, and services across all 254 counties",
    offerPrice: "400",
  },
