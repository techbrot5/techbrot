...
module.exports = {
  ...
  value: [
    ...
    { num: "02", title: "QuickBooks setup &amp; cleanup", body: "A Texas-correct chart of accounts, sales-tax items configured, and a cleanup to a CPA-ready standard when the file has fallen behind.", href: "/quickbooks/cleanup/", cta: "QuickBooks cleanup &rarr;" },
