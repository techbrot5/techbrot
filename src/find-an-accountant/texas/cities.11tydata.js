...
const cities = [
  ...
  { name: "Plano", note: "Texas&rsquo;s corporate-HQ capital &mdash; relocated headquarters and regional campuses along Legacy West, multi-entity structures, equity/executive comp, and SaaS/professional-services accounting.", href: "/find-an-accountant/texas/cities/plano/" },
  { name: "Corpus Christi", note: "A Gulf energy-export port &mdash; refining and petrochemicals, the Port of Corpus Christi, wind energy, and capital-project and export-logistics accounting.", href: "/find-an-accountant/texas/cities/corpus-christi/" },
  { name: "Lubbock", note: "The South Plains hub &mdash; cotton and agribusiness, ag-equipment dealers, Texas Tech&rsquo;s university economy, and a regional healthcare base.", href: "/find-an-accountant/texas/cities/lubbock/" },
  { name: "Laredo", note: "The #1 U.S. land port &mdash; a pure trade corridor of customs brokers, trucking/freight, and warehousing/3PL across the World Trade Bridge.", href: "/find-an-accountant/texas/cities/laredo/" },
  { name: "Killeen", note: "The Fort Cavazos military-base economy &mdash; defense and government contractors, base-services businesses, and military-family small business and rentals.", href: "/find-an-accountant/texas/cities/killeen/" },
];

const faq = [
  { q: "Which Texas cities do you serve?", a: "We have dedicated bookkeepers and city pages for the major metros &mdash; Houston, Dallas, Austin, San Antonio, Fort Worth, El Paso, Plano, Corpus Christi, Lubbock, Laredo, and Killeen &mdash; each built around that city&rsquo;s actual economy. We also serve every other city in all 254 Texas counties remotely on QuickBooks, with the same named bookkeeper and standard." },
