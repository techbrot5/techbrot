...
module.exports = {
  ...
  faq: [
    ...
    { q: "What changes the price?", a: "The scope &mdash; transaction volume, number of accounts, employees and contractors, your district-tax footprint, industry specifics, and multi-state exposure. We scope all of that on the free discovery call and quote a fixed fee. The fee only changes if you change the scope, and we re-quote in writing first." },
    { q: "Is the discovery call really free?", a: "Yes &mdash; a free, no-obligation 30-minute call with a Certified ProAdvisor who reviews your file and your California situation. You get a written fixed-fee scope within 3 business days; there&rsquo;s no charge for the call and no pressure to proceed." },
