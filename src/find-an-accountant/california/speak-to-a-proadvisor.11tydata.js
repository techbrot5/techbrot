/* /find-an-accountant/california/speak-to-a-proadvisor/ — CA HONEST-TRIAGE (money cluster BOFU).
...
module.exports = {
  cityMeta: {
    url: "https://techbrot.com/find-an-accountant/california/speak-to-a-proadvisor/",
    name: "Speak to a California QuickBooks ProAdvisor",
    description: "Speak to a Certified QuickBooks ProAdvisor at TechBrot — an independent firm, not Intuit or QuickBooks support. A free, no-obligation call about your California books. Independent firm; does not file California taxes.",
    serviceName: "California QuickBooks ProAdvisor Discovery Call",
    serviceType: "QuickBooks ProAdvisor advisory and discovery call",
    serviceDesc: "A free, no-obligation discovery call with a Certified QuickBooks ProAdvisor for California businesses — reviewing the client's own QuickBooks file and recommending setup, cleanup, monthly management, or advisory. Independent firm, not Intuit or QuickBooks product support; does not provide Intuit account/billing support or file California tax returns — coordinates with the client's CPA or EA.",
    areaServed: [{ type: "State", name: "California", sameAs: "https://en.wikipedia.org/wiki/California" }],
    audienceType: "California businesses wanting to speak with an independent Certified QuickBooks ProAdvisor about their own books",
    offerPrice: "0",
  },
  summary: [
    "<strong>Speaking to a TechBrot ProAdvisor is a free, no-obligation call with an actual Certified QuickBooks ProAdvisor</strong> who works with California businesses &mdash; not a salesperson, not a call center, and not Intuit. We review your own QuickBooks file, answer your questions, and tell you honestly what you need: setup, cleanup, monthly bookkeeping, or advisory.",
    "One boundary up front, so no one wastes a call: this is <strong>not Intuit and not QuickBooks product support</strong>. &ldquo;Certified QuickBooks ProAdvisor&rdquo; is a certification this firm holds from Intuit; it doesn&rsquo;t mean Intuit affiliation. For an Intuit account, billing, subscription, or login problem, contact Intuit directly &mdash; we can&rsquo;t access your Intuit account. And for filing California tax returns or representing you before the FTB, CDTFA, or EDD, that&rsquo;s your CPA or EA. What we do is the accounting work inside your own books.",
  ],
  split: [
    { tag: "Call us", title: "Talk to a ProAdvisor if&hellip;", body: "Your call is about how your own books and QuickBooks file are set up and run. A Certified ProAdvisor can help with:", list: [
      ...
      "You have California-specific questions (district sales tax, AB5, the $800 franchise tax)",
      "You want CFO-level advisory once the books are clean",
    ], cta: "Book the discovery call &rarr;", href: "/contact/?intent=california&state=california&source_type=state-money&funnel_stage=BOFU" },
  ...
  aiSummary: [
    ...
    { q: "What does speaking to a California ProAdvisor cost?", a: "<strong>Nothing.</strong> The discovery call is free and no-obligation. You speak with an actual Certified QuickBooks ProAdvisor about your own California books; if you want work done, you get a written fixed-fee scope within 3 business days." },
    { q: "What can a ProAdvisor call help with?", a: "The accounting work inside your own books &mdash; QuickBooks setup, cleanup, catch-up, monthly bookkeeping, California specifics (district sales tax, AB5, the $800 franchise tax), and CFO-level advisory. We do the books; your CPA files." },
    { q: "What can&rsquo;t this call help with?", a: "Intuit account, billing, subscription, or login issues, and QuickBooks product bugs &mdash; those require Intuit, which we can&rsquo;t access. And filing California returns or representation before the FTB/CDTFA/EDD is your CPA&rsquo;s or EA&rsquo;s." },
  ...
  conversation: [
    { num: "01", title: "You describe the situation", body: "Where your California books stand, what&rsquo;s prompting the call, and any deadline. No script, no qualifying interrogation." },
    { num: "02", title: "We review your own file", body: "A Certified ProAdvisor looks at your actual QuickBooks file &mdash; reconciliation, district sales tax, classification &mdash; and tells you what it really needs." },
  ...
  faq: [
    ...
    { q: "What does the call cost, and is there an obligation?", a: "The discovery call is free and carries no obligation. You speak with an actual Certified QuickBooks ProAdvisor about your own California books. If you decide you want work done, you receive a written fixed-fee scope within 3 business days &mdash; but there&rsquo;s no pressure and no sales script." },
    ...
    { q: "What California things can a ProAdvisor actually help with?", a: "The accounting inside your books: QuickBooks setup and cleanup, monthly bookkeeping, CDTFA district sales tax configured by location, AB5 contractor tracking, the $800 franchise-tax accrual, and CFO-level advisory once the books are clean. We keep the books CPA-ready; your CPA files the California returns." },
    ...
    { q: "Do you file my California taxes?", a: "No. TechBrot is an independent Certified QuickBooks ProAdvisor firm &mdash; we do the bookkeeping and QuickBooks work and keep the books CPA-ready, and your CPA or EA files the FTB, CDTFA, and income returns and represents you before the agencies. We are not affiliated with Intuit Inc." },
    { q: "Do you serve my California city or county?", a: "All 58 California counties, delivered remotely on QuickBooks &mdash; LA, the Bay Area, San Diego, the Central Valley, Sacramento and beyond. Your location changes the tax context but not the service or the named ProAdvisor on your file." },
