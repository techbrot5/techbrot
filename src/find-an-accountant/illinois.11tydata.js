...
module.exports = {
  ...
  teamDavid: {
    ...
    line: "Four decades reconciling, cleaning, and rebuilding books across construction, professional services, and nonprofits &mdash; the judgment behind every Illinois engagement.",
  },
  teamIntake: {
  ...
  faq: [
    ...
    { q: "Does TechBrot serve Illinois businesses?", a: "Yes. TechBrot delivers Certified QuickBooks ProAdvisor services, bookkeeping, payroll, Illinois sales tax compliance, and fractional CFO engagements to Illinois businesses across all 102 counties. Direct service by TechBrot&rsquo;s lead practice; trusted partner practices in Illinois where Chicago presence, manufacturing depth, or healthcare-practice accounting matters. Coverage spans Chicago, Aurora, Naperville, Rockford, Joliet, Springfield, and the entire state." },
    { q: "What is the Illinois Personal Property Replacement Tax (PPRT)?", a: "The PPRT is an Illinois entity-level tax on net income that replaced the former personal property tax. C-corporations pay 2.5%; S-corporations, partnerships, and trusts pay 1.5%. For a C-corp it stacks on the 7% corporate income tax for a combined 9.5%. Critically, S-corps and partnerships owe the 1.5% PPRT at the entity level even though they&rsquo;re pass-throughs - a surprise for owners new to Illinois. QuickBooks should track Illinois net income cleanly so the PPRT is supportable." },
    { q: "How does Illinois income tax work, and is there a PTE election?", a: "Illinois has a flat 4.95% personal income tax - no graduated brackets - and Chicago adds no city income tax. C-corporations pay 7% corporate income tax plus the 2.5% PPRT (9.5% combined). Illinois also offers a permanent Pass-Through Entity (PTE) tax election - made permanent by SB 1911 in December 2025 - letting S-corps and partnerships pay a 4.95% entity-level tax as a federal SALT-cap workaround. Whether to elect PTE is a key Illinois planning decision to make with your CPA." },
    { q: "How does Illinois sales tax work, and what is Chicago&rsquo;s cloud tax?", a: "The Illinois state rate is 6.25%, with county, city, and home-rule add-ons; Chicago&rsquo;s combined rate is 10.25%, among the highest big-city rates in the U.S. Illinois uses destination-based sourcing for remote sellers. Notably, Illinois doesn&rsquo;t tax SaaS - but Chicago does, via its Personal Property Lease Transaction Tax, which rose to 15% on January 1, 2026. SaaS and cloud providers with Chicago customers must collect it. QuickBooks must handle Illinois sales tax and, separately, the Chicago lease tax." },
