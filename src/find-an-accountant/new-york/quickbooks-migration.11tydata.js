...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a migration?", a: "Yes &mdash; start with a free 30-minute migration diagnostic, no obligation. A Certified ProAdvisor reviews your current platform, years of history, and integrations, runs a pre-migration audit, and sends a written fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=new-york\">book the diagnostic</a>. Most New York migrations continue directly into <a href=\"/find-an-accountant/new-york/monthly-bookkeeping/\">monthly bookkeeping</a> with the same ProAdvisor." },
