...
module.exports = {
  ...
  faq: [
    ...
    { q: "What determines where I land in a New York price range?", a: "Recurring work: transaction volume, number of accounts, payroll complexity, entities. Cleanup/catch-up: months or years involved, severity of issues. New York adds factors too &mdash; NYC sales-tax complexity, UBT allocation for partnerships. The discovery call surfaces these; the written scope reflects them." },
