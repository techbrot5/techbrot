...
module.exports = {
  ...
  faq: [
    ...
    { q: "How much does QuickBooks setup cost in New York?", a: "Setup runs $750&ndash;$5,000+ as a one-time fixed fee, depending on entity complexity, number of accounts, and whether you&rsquo;re migrating from another system. Simple single-entity setups land near the low end; multi-entity or migration-heavy setups higher. We quote a firm number against a written scope before starting." },
    ...
    { q: "Can I talk to a Certified ProAdvisor before committing to a setup?", a: "Yes &mdash; start with a free call, no obligation. A Certified ProAdvisor reviews your business structure, industry, and whether you&rsquo;re migrating from another system, recommends the right QuickBooks edition, and quotes a fixed fee in writing before any work begins. Call (877) 751-5575 or <a href=\"/contact/?intent=new-york\">book the call</a>. Most New York businesses then roll straight into <a href=\"/find-an-accountant/new-york/monthly-bookkeeping/\">monthly bookkeeping</a> so the file stays as clean as the day it was built." },
  ],
