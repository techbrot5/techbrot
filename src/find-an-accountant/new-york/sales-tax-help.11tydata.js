...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor about my New York sales tax?", a: "Yes &mdash; start with a free, no-obligation call. A named Certified ProAdvisor reviews where you sell, what you sell, and whether you&rsquo;re near the $500K / 100-transaction nexus threshold, and scopes the bookkeeping in writing. Call (877) 751-5575 or <a href=\"/contact/?intent=new-york\">book the call</a>. To be clear on the boundary: we track destination-based sales tax in QuickBooks, reconcile the liability, and prepare CPA-ready quarterly figures &mdash; the return is filed through NYS Web File by you or your CPA, and we don&rsquo;t represent you before the Tax Department. See the full <a href=\"/find-an-accountant/new-york/\">New York accounting</a> overview." },
  ],
