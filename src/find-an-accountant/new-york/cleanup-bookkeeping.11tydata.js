...
module.exports = {
  ...
  faq: [
    ...
    { q: "How much does bookkeeping cleanup cost in New York?", a: "Cleanup is priced by scope, not by the hour. Small single-year cleanups typically range from $1,500 to $3,500. Standard 12 to 24 month cleanups fall between $3,500 and $8,000. Multi-year cleanups involving payroll, inventory, or multi-entity structures typically range from $8,000 to $15,000 or more. Every cleanup is fixed-fee against a written scope &mdash; for a quote, book a free diagnostic or call <a href=\"tel:+18777515575\">(877) 751-5575</a>. See the <a href=\"#ny-svc-cleanupbk-pricing\">pricing scope section</a> above for tier details." },
    ...
    { q: "Do you handle New York and NYC sales tax during cleanup?", a: "Yes. Cleanup verifies sales-tax accruals against your filed New York returns and reconciles the liability in the books &mdash; including NYC&rsquo;s 8.875% combined rate where it applies, and destination-based rates for businesses selling across New York. We prepare accurate numbers; your CPA or you file the return through NYS Web File." },
