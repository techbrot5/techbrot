...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a Certified ProAdvisor before I commit?", a: "Yes &mdash; start with a free call, no obligation. A Certified QuickBooks ProAdvisor reviews which accounts have drifted and how far behind they are, then scopes either a one-time historical reconciliation or ongoing monthly service in writing. Call (877) 751-5575 or <a href=\"/contact/?intent=new-york\">book the call</a>. Most New York businesses keep reconciliation running as part of <a href=\"/find-an-accountant/new-york/monthly-bookkeeping/\">monthly bookkeeping</a> so the books stay trustworthy month after month." },
  ],
