...
module.exports = {
  ...
  faq: [
    ...
    { q: "Can I talk to a ProAdvisor before committing to a cleanup?", a: "Yes &mdash; start with a free 30-minute file diagnostic, no obligation. A Certified ProAdvisor reviews your QuickBooks file, identifies the data-integrity issues, and quotes a fixed-fee scope within 3 business days. Call (877) 751-5575 or <a href=\"/contact/?intent=new-york\">book the diagnostic</a>. If the file issues are paired with messy books across prior periods, ask about <a href=\"/find-an-accountant/new-york/cleanup-bookkeeping/\">bookkeeping cleanup</a> on the same call &mdash; the engagements pair seamlessly." },
