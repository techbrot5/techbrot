...
module.exports = {
  ...
  faq: [
    ...
    { q: "What QuickBooks version do you work in?", a: "Both QuickBooks Online and QuickBooks Desktop. Online is the default for most New York small businesses; Desktop (often hosted) still suits some inventory-heavy operations. We&rsquo;ll recommend the right fit and handle setup or migration if needed." },
    { q: "How do we start New York bookkeeping services?", a: "Book a free discovery call, or call <a href=\"tel:+18777515575\">(877) 751-5575</a>. We review your current books and your situation, determine whether you need cleanup, monthly service, or both, and send a written fixed-fee proposal within 3 business days. A named bookkeeper starts as soon as you approve the scope." },
  ],
