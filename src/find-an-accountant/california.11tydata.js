...
module.exports = {
  ...
  ecosystem: [
    { eyebrow: "Cluster 01", heading: "California money cluster", lede: "Primary engagements &mdash; the work behind &ldquo;quickbooks accountant near me&rdquo; and &ldquo;bookkeeper near me&rdquo; in California.", links: [
      { label: "CA QuickBooks Accountant / ProAdvisor", tag: "&#9733; umbrella" },
      { label: "CA Small Business Accountant" },
      { label: "CA Bookkeeping Services" },
      { label: "CA Virtual Bookkeeper" },
      { label: "Speak to a CA ProAdvisor", tag: "BOFU" },
      { label: "CA Pricing &amp; Engagement Fees" },
    ] },
    { eyebrow: "Cluster 02", heading: "California QuickBooks spokes", lede: "CA-specific QuickBooks ProAdvisor engagements we deliver today &mdash; each a dedicated California page on the roadmap.", links: [
      { label: "CA QuickBooks Setup" },
      { label: "CA QuickBooks Cleanup" },
      { label: "CA QuickBooks Reconciliation" },
      { label: "CA QuickBooks Migration" },
      { label: "CA QuickBooks Training" },
      { label: "CA QuickBooks Error Fixes" },
    ] },
    { eyebrow: "Cluster 03", heading: "California bookkeeping spokes", lede: "Recurring and project bookkeeping engagements scoped to California operational reality.", links: [
      { label: "CA Monthly Bookkeeping" },
      { label: "CA Cleanup &amp; Catch-Up Bookkeeping" },
      { label: "CA Urgent Bookkeeping" },
    ] },
    { eyebrow: "Cluster 04", heading: "California tax &amp; classification cluster", lede: "The genuinely CA-specific stack &mdash; AB5, district sales tax, FTB notices.", links: [
      { label: "CA Sales Tax Help (7.25% base &middot; district rates &middot; nexus)" },
      { label: "CA AB5 Worker Classification (ABC test &middot; EDD)" },
      { label: "CA State Tax / FTB Notice Help ($800 &middot; LLC fee)" },
      { label: "CA Business Tax Problems" },
    ] },
    { eyebrow: "Cluster 05", heading: "California industries", lede: "Vertical-specific accounting depth for California&rsquo;s leading sectors &mdash; the verticals with genuine CA-specific requirements.", links: [
      { label: "CA Ecommerce Accounting" },
      { label: "CA Agency, SaaS &amp; Production Accounting" },
      { label: "CA Restaurant Accounting" },
      { label: "CA Real Estate Accounting" },
      { label: "CA Professional Services Accounting" },
      { label: "CA Construction Accounting" },
    ] },
    { eyebrow: "Cluster 06", heading: "California cities", lede: "Local coverage for California&rsquo;s primary metros &mdash; the Bay Area, LA, San Diego, and the Central Valley.", links: [
      { label: "Los Angeles" },
      { label: "San Francisco" },
      { label: "San Diego" },
      { label: "San Jose" },
  ...
  ecosystemNote: "California pages publish on a rolling cadence. Until each dedicated page is live, every engagement above is delivered directly &mdash; <a href=\"/contact/?intent=california&amp;state=california&amp;source_type=location&amp;funnel_stage=MOFU\">start with the discovery call</a>.",
