/* /find-an-accountant/indiana/quickbooks-migration/ — IN SERVICE child (QB spoke), t-money.
 * Mirrors the proven DE child (delaware/quickbooks-migration.*) and the NY exemplar
 * (new-york/quickbooks-migration.*) with Indiana content per IN-FACTS.md. JSON front-matter
 * in the .njk; this file supplies content arrays + an eleventyComputed pageGraph (WebPage,
 * BreadcrumbList, Service, FAQPage).
 *
 * IN LOCALIZATION: DE's gross-receipts reconfiguration → Indiana SALES-TAX (flat 7% statewide,
 * NO local add-ons) + the 92-county LOCAL INCOME TAX (LIT) payroll-withholding angle (Form WH-4,
 * county of residence Jan 1 — never quote a specific county %), plus business personal-property
 * fixed-asset detail kept assessor-ready (Form 102/103, $2M exemption 2026; TechBrot does NOT
 * file the county return). Crossroads-of-America logistics/distribution + most-manufacturing-
 * intensive economy → multi-state nexus + manufacturers' inventory/history must migrate cleanly.
 * Intuit Desktop-sunset dates and the Bench shutdown are general QuickBooks/product facts
 * (web-verified, carried from the proven exemplars), not Indiana economics. PRICING: IN-FACTS has
 * NO migration pricing — the three tiers are written qualitatively (no fabricated dollar ranges);
 * the Service Offer carries no numeric price. provider = #organization; areaServed = State Indiana
 * (NO PostalAddress, NO geo, NO LocalBusiness — areaServed-only); reviewedBy #david-westgate.
 * HONESTY (R5): firm-level review byline (no founder name); independent firm — does NOT file the
 * Indiana, county LIT, sales-tax, or business personal-property returns; not a registered agent;
 * coordinates with the client's CPA/EA and assessor. */
function stripTags(html){return html.replace(/<[^>]+>/g,"").replace(/&rsquo;/g,"’").replace(/&lsquo;/g,"‘").replace(/&ldquo;/g,"“").replace(/&rdquo;/g,"”").replace(/&mdash;/g,"—").replace(/&ndash;/g,"–").replace(/&rarr;/g,"→").replace(/&amp;/g,"&").replace(/&nbsp;/g," ").replace(/&middot;/g,"·").replace(/\s+/g," ").trim();}

module.exports = {
  // SUMMARY — real-H2 migration TL;DR. (H2: What Indiana QuickBooks migration actually is.)
  summary: [
    "<strong>Professional QuickBooks migration</strong> moves your accounting from <a href=\"/quickbooks/desktop/\">QuickBooks Desktop</a> to <a href=\"/quickbooks/online/\">QuickBooks Online</a> &mdash; or from Wave, Xero, FreshBooks, Sage, or Bench into QuickBooks &mdash; cleanly and completely. It is <strong>data conversion</strong>, <strong>chart-of-accounts restructuring</strong> for Online&rsquo;s different structure, <strong>historical reconciliation</strong>, <strong>integration replacement</strong> (Desktop integrations rarely transfer directly), <strong>payroll-history migration</strong> with each employee&rsquo;s county LIT withholding intact, <strong>opening-balance verification</strong> tied to a conversion date, <strong>Indiana sales-tax reconfiguration</strong>, a <strong>documented handoff</strong>, training, and <strong>CPA coordination</strong>.",
    "The work begins with a pre-migration audit, not a file dump. We map what carries forward cleanly &mdash; lists, balances, open transactions &mdash; and what has to be rebuilt: Desktop-only integrations, custom reports, advanced inventory, class and location structures Online models differently, and any multi-plant or multi-location structure. Every migrated file is then validated against the old one: trial balance to trial balance, A/R and A/P aging, bank and credit-card balances as of the cutover, fixed-asset detail kept assessor-ready, and sales-tax liability tied to a date &mdash; so the new file proves out before anyone relies on it.",
    "Intuit&rsquo;s Desktop sunset &mdash; new-subscription stop-sell in September 2024, support ending version by version through September 2027 &mdash; is why most Indiana businesses still on Desktop are migrating now. Engagements are fixed-fee against a written scope, by history depth and complexity, completed in 3&ndash;8 weeks. Many continue directly into <a href=\"/find-an-accountant/indiana/monthly-bookkeeping/\">monthly bookkeeping</a> in the new file. We do the migration; your CPA files. Independent firm &mdash; not affiliated with Intuit Inc.; does not file Indiana taxes.",
  ],

  // URGENCY — Intuit Desktop sunset timeline. (H2: What's actually happening… + 4 H3s)
  ...
  // AI SUMMARY — 5 entity-dense Q&As. (H2: Indiana QuickBooks migration, in five questions.)
  aiSummary: [
    { q: "Why migrate from Desktop to Online?", a: "Intuit is phasing out Desktop. <strong>New-subscription stop-sell was September 30, 2024</strong>; Desktop 2023 lost support May 31, 2026; <strong>Desktop 2024 loses support September 30, 2027</strong>, after which payroll tables, bank feeds, and security updates stop. Enterprise is exempt. For Indiana businesses on Desktop, it&rsquo;s a question of timing, not necessity." },
    { q: "What does it cost?", a: "Fixed one-time, against a written scope &mdash; the fee is set by history depth, integration count, and complexity, and confirmed within 3 business days of a free diagnostic. No hourly billing, no surprises." },
  ...
  // SIGNALS — six "if any apply, the answer is yes" cards. (H2: If any of these apply… + 6 H3s)
  ...
  signals: [
    ...
    { title: "Your CPA can&rsquo;t work in your current platform.", body: "Most U.S. CPAs work primarily in QuickBooks Online. If your accountant is asking you to migrate, the business case is already made." },
    { title: "You&rsquo;re facing an audit, capital raise, or business sale.", body: "Buyers, investors, and auditors read your books on a modern, cloud-accessible platform. A Desktop file is friction; a poorly migrated QBO file is worse &mdash; and Indiana deals draw out-of-state diligence." },
  ...
  // PHASES — four-phase migration methodology. (H2: Every migration runs four phases. + 4 H3s)
  ...
  phases: [
    ...
    { phase: "Phase 2", title: "Data Conversion &amp; Restructure", body: "Data converted from Desktop, or rebuilt from scratch for non-QuickBooks sources. Chart of accounts restructured for QBO. Opening balances verified to the conversion date. Customer and vendor records cleaned. Inventory, items, and historical transactions reconciled to statements.", meta: "Typical: Weeks 2&ndash;4" },
    { phase: "Phase 3", title: "Integration Replacement &amp; Configuration", body: "Desktop integrations replaced with QBO-compatible equivalents. Bank feeds reconnected. Payroll history and YTD migrated with each employee&rsquo;s county LIT withholding intact. Sales-tax items reconfigured to collect the flat 7% on taxable goods and services. Test transactions verified.", meta: "Typical: Weeks 4&ndash;6" },
  ...
  // DELIVERABLES — two checks-lists. (H2: What you actually get… + 2 H3s)
  ...
  // PRICING — three fixed-fee tiers. IN-FACTS lacks migration pricing → ranges qualitative.
  // (H2: Fixed-fee migration, written scope, no surprises. + 3 H3s)
  pricing: [
    { tier: "Tier 01", title: "Simple Migration", range: "<strong>Fixed-fee by scope</strong>", fit: "Single-entity Desktop-to-Online, under 3 years of history, few integrations, no inventory, no payroll history.", href: "/contact/?intent=indiana&amp;state=indiana&amp;source_type=state-spoke&amp;funnel_stage=MOFU", cta: "Scope a Simple migration &rarr;" },
    { tier: "Tier 02 &middot; Most common", title: "Standard Migration", range: "<strong>Fixed-fee by scope</strong>", fit: "Multi-year history (3&ndash;7 years), 3&ndash;6 integrations, payroll-history migration with county LIT withholding, inventory, or cross-platform (Wave/Xero/Bench).", href: "/contact/?intent=indiana&amp;state=indiana&amp;source_type=state-spoke&amp;funnel_stage=MOFU", cta: "Scope a Standard migration &rarr;" },
    { tier: "Tier 03", title: "Complex Migration", range: "<strong>Fixed-fee by scope</strong>", fit: "Multi-entity / multi-plant, multi-location, industry-specific operations (manufacturing, logistics/distribution, construction), multi-state nexus, Enterprise migrations, 6+ integrations, custom report rebuild.", href: "/contact/?intent=indiana&amp;state=indiana&amp;source_type=state-spoke&amp;funnel_stage=MOFU", cta: "Scope a Complex migration &rarr;" },
  ],
  pricingNote: "Every migration is a fixed one-time fee against a written scope, set by the diagnostic &mdash; history depth, integration count, and complexity. QuickBooks Setup, when a non-QuickBooks platform is rebuilt from scratch, runs from $750; pre-migration QuickBooks Cleanup runs from $1,200. QuickBooks Online and Enterprise subscriptions pass through at Intuit list pricing. Optional continuation into <a href=\"/find-an-accountant/indiana/monthly-bookkeeping/\">monthly bookkeeping</a> runs from $400/month depending on complexity.",

  // INTUIT TOOL — honest framing. (H2: What Intuit's migration tool does — and doesn't do.)
  tool: [
  ...
  // ADVISORY — what migration is actually for. (H2: Migration is the modernization…)
  advisory: [
    ...
    "A well-migrated QuickBooks Online file enables what Desktop couldn&rsquo;t: <strong>cloud access</strong> for distributed teams and the multi-plant operations common across Indiana&rsquo;s manufacturing and logistics base, <strong>real-time CPA collaboration</strong> instead of file-handoff cycles, <strong>modern integrations</strong> with payment processors and e-commerce, <strong>AI-assisted bookkeeping</strong> that compounds efficiency, <strong>better lender and investor positioning</strong>, and the foundation for advisory &mdash; cash-flow forecasting, scenario planning, margin analysis &mdash; that requires data your CPA can actually access.",
    "Most TechBrot migrations transition into <a href=\"/find-an-accountant/indiana/monthly-bookkeeping/\"><strong>monthly bookkeeping</strong></a> with the same ProAdvisor, and many continue into payroll with county LIT withholding, sales-tax compliance, and eventually advisory. As automation handles routine entry, that judgment layer is where the value lives. <strong>The migration is the modernization moment</strong> &mdash; done right, it unlocks the next decade.",
  ],
  ...
  operatorBody: [
    ...
    "Quality review backs every migration against TechBrot&rsquo;s published standards, and the same ProAdvisor can continue with <a href=\"/find-an-accountant/indiana/monthly-bookkeeping/\">monthly bookkeeping</a> in the new system if you want the relationship to continue. <a href=\"/trust/\">Trust &amp; methodology &rarr;</a>",
  ],
  operatorCreds: [
    { label: "Certifications", detail: "QuickBooks ProAdvisor &mdash; Online (L2), Desktop, Enterprise, Payroll" },
    { label: "Coverage", detail: "Desktop &amp; Online migration specialists &middot; served remotely across all 92 Indiana counties" },
  ...
  // RELATED — what migration commonly pairs with. (H2: What migration commonly pairs with. + 4 H3s)
  related: [
    { title: "Monthly bookkeeping", body: "The natural continuation. Same ProAdvisor, no rework, monthly close runs cleanly in the new platform.", href: "/find-an-accountant/indiana/monthly-bookkeeping/", cta: "Monthly bookkeeping &rarr;" },
    { title: "QuickBooks cleanup", body: "If your existing file has structural issues, cleanup before migration prevents bad data carrying forward.", href: "/find-an-accountant/indiana/quickbooks-cleanup/", cta: "Cleanup &rarr;" },
    { title: "Indiana sales tax help", body: "The flat 7% statewide sales tax configured correctly on taxable goods and services in your new QuickBooks Online file.", href: "/find-an-accountant/indiana/sales-tax-help/", cta: "Sales tax help &rarr;" },
    { title: "County income tax help", body: "The 92-county LIT withholding matrix &mdash; Form WH-4, county of residence on January 1 &mdash; set up in payroll the right way.", href: "/find-an-accountant/indiana/county-income-tax-help/", cta: "County income tax help &rarr;" },
  ],
  ...
  faq: [
    ...
    { q: "Will my Indiana sales tax and county LIT withholding carry over correctly?", a: "Yes &mdash; that&rsquo;s a core part of the migration. Indiana charges a single flat 7% state sales tax with no county or city add-ons, so your sales-tax items and agency are reconfigured to collect that one rate on taxable goods and services in the new file. On payroll, every employee&rsquo;s county Local Income Tax (LIT) withholding migrates intact &mdash; the rate follows the county of residence on January 1, established on Form WH-4 &mdash; so withholding keeps running correctly after cutover. Each of Indiana&rsquo;s 92 counties sets its own LIT rate; we configure the rates you give us and defer to your CPA and the Indiana Department of Revenue on the current figures. We keep the books accurate; we do not file the LIT or sales-tax returns." },
    { q: "What happens to my fixed assets and business personal property in the migration?", a: "Your fixed-asset detail &mdash; acquisition cost and in-service dates &mdash; migrates intact so the books stay assessor-ready. Indiana raised the business personal-property exemption to $2,000,000 for 2026: if your total business personal property in a county costs less than that on the assessment date it is exempt, but the exemption still has to be declared on Form 102 or 103. Preserving that asset detail in the migrated file keeps you positioned to file. To be clear, TechBrot keeps the books and coordinates with your CPA and the county assessor &mdash; it does not file the personal-property return as agent." },
  ...
  eleventyComputed: {
    pageGraph(data){
      const url="https://techbrot.com/find-an-accountant/indiana/quickbooks-migration/";
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":"Indiana QuickBooks Migration","description":"Professional QuickBooks Desktop-to-Online migration for Indiana businesses — data conversion, integration replacement, historical reconciliation, sales-tax and county-LIT setup, and CPA-coordinated handoff. Fixed-fee, by a Certified ProAdvisor.","isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"breadcrumb":{"@id":url+"#breadcrumb"},"inLanguage":"en-US","primaryImageOfPage":{"@type":"ImageObject","url":"https://techbrot.com/assets/og/cards/find-an-accountant-indiana-quickbooks-migration.png"},"speakable":{"@type":"SpeakableSpecification","cssSelector":["#in-svc-migration-summary","#in-svc-migration-ai-summary-list"]},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"lastReviewed":"2026-06-26"},
        ...
        {"@type":"Service","@id":url+"#service","name":"Indiana QuickBooks Migration","serviceType":"QuickBooks Desktop-to-Online migration","description":"Professional QuickBooks migration for Indiana businesses — Desktop-to-Online and cross-platform, with data conversion, chart-of-accounts restructuring, historical reconciliation, integration replacement, sales-tax and county-LIT setup, and CPA-coordinated handoff, by a Certified ProAdvisor. Independent Certified QuickBooks ProAdvisor firm; not affiliated with Intuit Inc.; does not file the Indiana, county LIT, sales-tax, or business personal-property returns — coordinates with the client's CPA, EA, and county assessor.","provider":{"@id":"https://techbrot.com/#organization"},"areaServed":{"@type":"State","name":"Indiana","sameAs":"https://en.wikipedia.org/wiki/Indiana"},
          "audience":{"@type":"BusinessAudience","audienceType":"Indiana small and mid-sized businesses migrating to QuickBooks Online from Desktop or another accounting platform"},
          "offers":{"@type":"Offer","name":"QuickBooks migration","description":"Fixed one-time fee against a written scope; quoted within 3 business days of a free diagnostic.","url":url}},
