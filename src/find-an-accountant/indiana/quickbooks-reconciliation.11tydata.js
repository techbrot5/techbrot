/* /find-an-accountant/indiana/quickbooks-reconciliation/ — IN SERVICE child (QB spoke), t-money.
 * Mirrors the proven NY/DE exemplars (new-york & delaware quickbooks-reconciliation.*) with
 * Indiana content per IN-FACTS.md. JSON front-matter in the .njk; this file supplies content
 * arrays + an eleventyComputed pageGraph (WebPage, BreadcrumbList, Service, FAQPage).
 *
 * IN LOCALIZATION: Indiana has a flat 7% sales tax (no local sales tax), so the sales-tax-liability
 * reconciliation workstream stays relevant; unreconciled books are a common Indiana DOR notice
 * trigger; merchant accounts for ecommerce and the state's logistics/distribution and manufacturing
 * base. PRICING: monthly bookkeeping from $400/mo (IN-FACTS); standalone historical reconciliation
 * written qualitatively. provider = #organization; areaServed = State Indiana; reviewedBy
 * #david-westgate on WebPage. NO street address, NO LocalBusiness. HONESTY (R5): firm-level review
 * byline (no founder name); independent firm — does NOT file Indiana returns; coordinates with the
 * client's CPA. */
...
module.exports = {
  ...
  summary: [
    ...
    "Reconciliation is usually part of <a href=\"/find-an-accountant/indiana/monthly-bookkeeping/\">monthly bookkeeping</a> (from $400/mo); standalone historical reconciliation of accounts that have drifted is scoped separately as a fixed fee. Unreconciled books are a common <a href=\"/find-an-accountant/indiana/sales-tax-help/\">Indiana sales-tax</a> notice trigger, so this quietly matters for compliance. We deliver reconciled books and coordinate with your CPA, who files &mdash; TechBrot is an independent Certified QuickBooks ProAdvisor firm, not affiliated with Intuit Inc., and does not file Indiana tax returns.",
  ],

  // AI SUMMARY — 5 entity-dense Q&As. (H2: QuickBooks Reconciliation in Indiana, in five questions.)
  aiSummary: [
    ...
    { q: "Can unreconciled books cause tax problems?", a: "<strong>Yes</strong> &mdash; drifted filings and wrong sales-tax returns are a common Indiana notice trigger; reconciled books are what let you prove your real numbers if the Department of Revenue questions a return." },
  ],

  // WHAT'S INVOLVED — five reconciliation workstreams. (H2: How we handle… + 5 H3s)
  handle: [
    { num: "01 &middot; Monthly", title: "All accounts reconciled monthly", body: "Every bank, credit-card, loan, line-of-credit, and merchant account &mdash; Stripe, Square, PayPal &mdash; matched to its statement, every period. Reconciling the merchant accounts is where many Indiana ecommerce and distribution businesses find the biggest discrepancies." },
    ...
    { num: "04 &middot; Sales tax", title: "Sales-tax liability reconciled", body: "The sales-tax-liability account reconciled in the books against what was collected and remitted at Indiana&rsquo;s flat 7% rate, so your position is accurate and defensible. We reconcile the account; your CPA files the return." },
  ...
  scopeNote: "Sales tax is tracked and reconciled in the books so the return is accurate; your CPA (or you) files it with the Indiana Department of Revenue through its INTIME portal. TechBrot does not file tax returns or represent clients before tax authorities.",
  ...
  advisoryBody: [
    ...
    "The same judgment is what keeps a reconciliation-discrepancy account from quietly absorbing errors month after month until the file needs a full <a href=\"/find-an-accountant/indiana/cleanup-bookkeeping/\">cleanup</a>. As automation handles the routine matching, the human layer &mdash; verifying, investigating, and tying each account back to reality &mdash; is where the value is. <a href=\"/find-an-accountant/indiana/monthly-bookkeeping/\">Keep it reconciled monthly &rarr;</a>",
  ],
  ...
  eleventyComputed: {
    pageGraph(data){
      const url="https://techbrot.com/find-an-accountant/indiana/quickbooks-reconciliation/";
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":"Indiana QuickBooks reconciliation","description":"QuickBooks reconciliation for Indiana businesses — every bank, credit-card, loan, and merchant account tied to its statement each month, discrepancies and duplicates resolved, the reconciliation-discrepancy and undeposited-funds accounts cleared, and sales-tax liability reconciled, by a Certified ProAdvisor.","isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"breadcrumb":{"@id":url+"#breadcrumb"},"inLanguage":"en-US","primaryImageOfPage":{"@type":"ImageObject","url":"https://techbrot.com/assets/og/cards/find-an-accountant-indiana-quickbooks-reconciliation.png"},"speakable":{"@type":"SpeakableSpecification","cssSelector":["#in-svc-recon-summary","#in-svc-recon-ai-summary-list"]},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"lastReviewed":"2026-06-26"},
        ...
        {"@type":"Service","@id":url+"#service","name":"Indiana QuickBooks Reconciliation Service","serviceType":"QuickBooks account reconciliation","description":"QuickBooks reconciliation for Indiana businesses: every bank, credit-card, loan, line-of-credit, and merchant account reconciled against the actual statement each month, discrepancies and duplicates resolved, the reconciliation-discrepancy and undeposited-funds accounts cleared, beginning-balance mismatches corrected, and sales-tax liability reconciled. Delivered fixed-fee by a Certified QuickBooks ProAdvisor. Independent Certified QuickBooks ProAdvisor firm; does not file Indiana tax returns — coordinates with the client's CPA or EA.","provider":{"@id":"https://techbrot.com/#organization"},"areaServed":{"@type":"State","name":"Indiana","sameAs":"https://en.wikipedia.org/wiki/Indiana"},
