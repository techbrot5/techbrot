...
module.exports = {
  ...
  ecosystem: [
    { eyebrow: "Cluster 01", heading: "Florida money cluster", lede: "The primary Florida demand we serve &mdash; &ldquo;quickbooks accountant near me&rdquo; and &ldquo;bookkeeper near me&rdquo; intent statewide.", items: ["Florida QuickBooks Accountant / ProAdvisor &mdash; the umbrella engagement", "Florida Small Business Accountant", "Florida Bookkeeping Services", "Florida Virtual Bookkeeper", "Speak to a Florida ProAdvisor", "Florida pricing &amp; engagement fees"] },
    { eyebrow: "Cluster 02", heading: "Florida QuickBooks spokes", lede: "FL-specific QuickBooks ProAdvisor engagements, each scoped on the discovery call.", items: ["Florida QuickBooks Setup", "Florida QuickBooks Cleanup", "Florida QuickBooks Reconciliation", "Florida QuickBooks Migration", "Florida QuickBooks Training", "Florida QuickBooks Error Fixes"] },
    { eyebrow: "Cluster 03", heading: "Florida bookkeeping spokes", lede: "Recurring and project bookkeeping engagements scoped to Florida operational reality.", items: ["Florida Monthly Bookkeeping", "Florida Cleanup &amp; Catch-Up Bookkeeping", "Florida Urgent Bookkeeping"] },
    { eyebrow: "Cluster 04", heading: "Florida tax cluster", lede: "The genuinely Florida-specific tax stack &mdash; sales tax on services, county surtax, the commercial-rent repeal, and the corporate income tax.", items: ["Florida Sales Tax (6% + county surtax &middot; taxable services)", "Florida Business Tax (5.5% C-corp &middot; CST &middot; DOR notices)"] },
    { eyebrow: "Cluster 05", heading: "Florida industries", lede: "Vertical depth for Florida&rsquo;s leading sectors &mdash; where Florida creates genuinely distinct requirements.", items: ["Restaurant &amp; Hospitality", "Healthcare Practice", "Dental Practice", "Real Estate", "Construction", "Home Services"] },
    { eyebrow: "Cluster 06", heading: "Florida cities", lede: "Florida&rsquo;s primary metros &mdash; the major population and business centers we serve directly.", items: ["Miami (Miami-Dade County)", "Orlando (Orange County)", "Tampa (Hillsborough County)", "Jacksonville (Duval County)", "Fort Lauderdale (Broward County)", "St. Petersburg (Pinellas County)"] },
  ],
  ecosystemNote: "Florida is served as a single statewide engagement today &mdash; all 67 counties, every cluster above, scoped on one discovery call. Dedicated Florida service, industry, and city pages publish on a rolling cadence.",
