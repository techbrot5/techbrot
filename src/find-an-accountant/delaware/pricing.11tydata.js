...
module.exports = {
  ...
  faq: [
    ...
    { q: "What determines where I land in a Delaware price range?", a: "Recurring work: transaction volume, number of accounts, entities, history depth. <a href=\"/find-an-accountant/delaware/cleanup-bookkeeping/\">Cleanup/catch-up</a>: months or years involved, severity of issues. Delaware adds factors too &mdash; gross-receipts tracking by business activity, the franchise-tax reserve, Wilmington wage-tax setup, and holding-company or multi-entity structure. The discovery call surfaces these; the written scope reflects them." },
    ...
    { q: "Do you handle Delaware gross receipts and the franchise tax in pricing?", a: "<a href=\"/find-an-accountant/delaware/gross-receipts-tax-help/\">Gross-receipts tax help</a> is scoped as its own line (from $500) or built into monthly bookkeeping &mdash; Delaware has no sales tax, so QuickBooks tracks the seller&rsquo;s receipts by business activity so the right rate and exclusion apply. <a href=\"/find-an-accountant/delaware/franchise-tax-help/\">Franchise-tax help</a> (from $300) tracks and reserves for the annual franchise tax and confirms the lower-tax method. We do not file either &mdash; your registered agent or CPA files; we keep the books that support the filing." },
