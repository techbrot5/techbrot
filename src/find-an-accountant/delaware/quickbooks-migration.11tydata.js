/* /find-an-accountant/delaware/quickbooks-migration/ — DE SERVICE child (QB spoke), t-money.
 * Mirrors the proven NY exemplar (new-york/quickbooks-migration.*) with Delaware content per
 ...
 *
 * DE LOCALIZATION: NY's NYC/NY sales-tax reconfiguration → Delaware GROSS-RECEIPTS reconfiguration
 * (by activity); per-entity holding-company structure noted. Intuit Desktop-sunset dates and the
 * Bench shutdown are general QuickBooks/product facts (web-verified, carried from the proven NY
 * exemplar), not Delaware economics. PRICING: DE-FACTS has NO migration pricing — the three tiers
 * are written qualitatively (no fabricated dollar ranges); the Service Offer carries no numeric
 * price. provider = #organization; areaServed = State Delaware; reviewedBy #david-westgate.
 * HONESTY (R5): firm-level review byline (no founder name); independent firm — does NOT file
 * Delaware returns or the franchise tax; coordinates with the client's CPA. */
function stripTags(html){return html.replace(/<[^>]+>/g,"").replace(/&rsquo;/g,"’").replace(/&lsquo;/g,"‘").replace(/&ldquo;/g,"“").replace(/&rdquo;/g,"”").replace(/&mdash;/g,"—").replace(/&ndash;/g,"–").replace(/&rarr;/g,"→").replace(/&amp;/g,"&").replace(/&nbsp;/g," ").replace(/&middot;/g,"·").replace(/\s+/g," ").trim();}

module.exports = {
  // SUMMARY — real-H2 migration TL;DR. (H2: What Delaware QuickBooks migration actually is.)
  summary: [
    "<strong>Professional QuickBooks migration</strong> moves your accounting from <a href=\"/quickbooks/desktop/\">QuickBooks Desktop</a> to <a href=\"/quickbooks/online/\">QuickBooks Online</a> &mdash; or from Wave, Xero, FreshBooks, Sage, or Bench into QuickBooks &mdash; cleanly and completely. It is <strong>data conversion</strong>, <strong>chart-of-accounts restructuring</strong> for Online&rsquo;s different structure, <strong>historical reconciliation</strong>, <strong>integration replacement</strong> (Desktop integrations rarely transfer directly), <strong>payroll-history migration</strong>, <strong>opening-balance verification</strong> tied to a conversion date, <strong>gross-receipts-tax reconfiguration</strong>, a <strong>documented handoff</strong>, training, and <strong>CPA coordination</strong>.",
    "The work begins with a pre-migration audit, not a file dump. We map what carries forward cleanly &mdash; lists, balances, open transactions &mdash; and what has to be rebuilt: Desktop-only integrations, custom reports, advanced inventory, class and location structures Online models differently, and any per-entity holding-company structure. Every migrated file is then validated against the old one: trial balance to trial balance, A/R and A/P aging, bank and credit-card balances as of the cutover, and gross-receipts liability tied to a date &mdash; so the new file proves out before anyone relies on it.",
    "Intuit&rsquo;s Desktop sunset &mdash; new-subscription stop-sell in September 2024, support ending version by version through September 2027 &mdash; is why most Delaware businesses still on Desktop are migrating now. Engagements are fixed-fee against a written scope, by history depth and complexity, completed in 3&ndash;8 weeks. Many continue directly into <a href=\"/find-an-accountant/delaware/monthly-bookkeeping/\">monthly bookkeeping</a> in the new file. We do the migration; your CPA files. Independent firm &mdash; not affiliated with Intuit Inc.; does not file Delaware taxes.",
  ],
  ...
  signals: [
    ...
    { title: "You&rsquo;re facing an audit, capital raise, or business sale.", body: "Buyers, investors, and auditors read your books on a modern, cloud-accessible platform. A Desktop file is friction; a poorly migrated QBO file is worse &mdash; and Delaware deals draw out-of-state diligence." },
  ...
  phases: [
    ...
    { phase: "Phase 3", title: "Integration Replacement &amp; Configuration", body: "Desktop integrations replaced with QBO-compatible equivalents. Bank feeds reconnected. Payroll history and YTD migrated. Gross-receipts tracking reconfigured by business activity for QBO. Third-party tools reconnected. Test transactions verified.", meta: "Typical: Weeks 4&ndash;6" },
  ...
  deliverablesAlways: {
    ...
    items: [
      ...
      "Gross-receipts-tax reconfiguration by activity",
  ...
  deliverablesScope: {
    ...
    items: [
      ...
      "Payroll history &amp; YTD migration (incl. Wilmington wage tax)",
      "Inventory data migration &amp; valuation",
      "Job costing &amp; project history",
      "Class &amp; location tracking rebuild",
      "Multi-entity / holding-company consolidation rebuild",
  ...
  // PRICING — three fixed-fee tiers. DE-FACTS lacks migration pricing → ranges qualitative.
  // (H2: Fixed-fee migration, written scope, no surprises. + 3 H3s)
  pricing: [
    { tier: "Tier 01", title: "Simple Migration", range: "<strong>Fixed-fee by scope</strong>", fit: "Single-entity Desktop-to-Online, under 3 years of history, few integrations, no inventory, no payroll history.", href: "/contact/?intent=delaware&amp;state=delaware&amp;source_type=state-spoke&amp;funnel_stage=MOFU", cta: "Scope a Simple migration &rarr;" },
    { tier: "Tier 02 &middot; Most common", title: "Standard Migration", range: "<strong>Fixed-fee by scope</strong>", fit: "Multi-year history (3&ndash;7 years), 3&ndash;6 integrations, payroll-history migration, inventory, or cross-platform (Wave/Xero/Bench).", href: "/contact/?intent=delaware&amp;state=delaware&amp;source_type=state-spoke&amp;funnel_stage=MOFU", cta: "Scope a Standard migration &rarr;" },
    { tier: "Tier 03", title: "Complex Migration", range: "<strong>Fixed-fee by scope</strong>", fit: "Multi-entity / holding-company, multi-location, industry-specific operations (construction, manufacturing, agriculture), Enterprise migrations, 6+ integrations, custom report rebuild.", href: "/contact/?intent=delaware&amp;state=delaware&amp;source_type=state-spoke&amp;funnel_stage=MOFU", cta: "Scope a Complex migration &rarr;" },
  ],
  pricingNote: "Every migration is a fixed one-time fee against a written scope, set by the diagnostic &mdash; history depth, integration count, and complexity. QuickBooks Online and Enterprise subscriptions pass through at Intuit list pricing. Optional continuation into <a href=\"/find-an-accountant/delaware/monthly-bookkeeping/\">monthly bookkeeping</a> runs from $400/month depending on complexity.",
  ...
  advisory: [
    ...
    "A well-migrated QuickBooks Online file enables what Desktop couldn&rsquo;t: <strong>cloud access</strong> for distributed teams and the many Delaware entities run from out of state, <strong>real-time CPA collaboration</strong> instead of file-handoff cycles, <strong>modern integrations</strong> with payment processors and e-commerce, <strong>AI-assisted bookkeeping</strong> that compounds efficiency, <strong>better lender and investor positioning</strong>, and the foundation for advisory &mdash; cash-flow forecasting, scenario planning, margin analysis &mdash; that requires data your CPA can actually access.",
    "Most TechBrot migrations transition into <a href=\"/find-an-accountant/delaware/monthly-bookkeeping/\"><strong>monthly bookkeeping</strong></a> with the same ProAdvisor, and many continue into payroll, gross-receipts compliance, and eventually advisory. As automation handles routine entry, that judgment layer is where the value lives. <strong>The migration is the modernization moment</strong> &mdash; done right, it unlocks the next decade.",
  ],
  ...
  operatorBody: [
    ...
    "Quality review backs every migration against TechBrot&rsquo;s published standards, and the same ProAdvisor can continue with <a href=\"/find-an-accountant/delaware/monthly-bookkeeping/\">monthly bookkeeping</a> in the new system if you want the relationship to continue. <a href=\"/trust/\">Trust &amp; methodology &rarr;</a>",
  ],
  operatorCreds: [
    { label: "Certifications", detail: "QuickBooks ProAdvisor &mdash; Online (L2), Desktop, Enterprise, Payroll" },
    { label: "Coverage", detail: "Desktop &amp; Online migration specialists &middot; all three Delaware counties, delivered remotely" },
  ...
  related: [
    { title: "Monthly bookkeeping", body: "The natural continuation. Same ProAdvisor, no rework, monthly close runs cleanly in the new platform.", href: "/find-an-accountant/delaware/monthly-bookkeeping/", cta: "Monthly bookkeeping &rarr;" },
    { title: "QuickBooks setup", body: "When migrating from a non-QuickBooks platform, setup runs alongside migration to build the new file correctly from scratch.", href: "/find-an-accountant/delaware/quickbooks-setup/", cta: "Setup &rarr;" },
    { title: "QuickBooks cleanup", body: "If your existing file has structural issues, cleanup before migration prevents bad data carrying forward.", href: "/find-an-accountant/delaware/quickbooks-cleanup/", cta: "Cleanup &rarr;" },
    { title: "Gross receipts tax help", body: "Activity-based gross-receipts tracking configured correctly in your new QuickBooks Online file.", href: "/find-an-accountant/delaware/gross-receipts-tax-help/", cta: "Gross receipts help &rarr;" },
  ],
  ...
  faq: [
    ...
    { q: "What does professional QuickBooks migration include?", a: "Pre-migration file audit, data conversion, chart-of-accounts restructuring, historical reconciliation, integration replacement, payroll-history migration, customer and vendor cleanup, opening-balance verification, gross-receipts reconfiguration by activity, first-month post-migration reconciliation, training with recorded video, a documented summary, and CPA coordination. We do the migration; your CPA files." },
    { q: "QuickBooks Enterprise or QuickBooks Online for my Delaware business?", a: "Product selection is part of the diagnostic. QBO Plus or Advanced fits most Delaware small businesses &mdash; and the holding companies and out-of-state-owned entities run remotely. Enterprise fits operations needing Desktop-level features &mdash; advanced inventory, industry editions (contractor, manufacturing, nonprofit), or multi-location accounting &mdash; and is the one Desktop line Intuit continues to sell and support. We recommend Enterprise only when QBO genuinely won&rsquo;t fit." },
  ],

  eleventyComputed: {
    pageGraph(data){
      const url="https://techbrot.com/find-an-accountant/delaware/quickbooks-migration/";
      return {"@context":"https://schema.org","@graph":[
        {"@type":"WebPage","@id":url+"#webpage","url":url,"name":"Delaware QuickBooks Migration","description":"Professional QuickBooks Desktop-to-Online migration for Delaware businesses — data conversion, integration replacement, historical reconciliation, gross-receipts-tax setup, and CPA-coordinated handoff. Fixed-fee, by a Certified ProAdvisor.","isPartOf":{"@id":"https://techbrot.com/#website"},"about":{"@id":"https://techbrot.com/#organization"},"publisher":{"@id":"https://techbrot.com/#organization"},"breadcrumb":{"@id":url+"#breadcrumb"},"inLanguage":"en-US","primaryImageOfPage":{"@type":"ImageObject","url":"https://techbrot.com/assets/og/cards/find-an-accountant-delaware-quickbooks-migration.png"},"speakable":{"@type":"SpeakableSpecification","cssSelector":["#de-svc-migration-summary","#de-svc-migration-ai-summary-list"]},"reviewedBy":{"@id":"https://techbrot.com/#david-westgate"},"lastReviewed":"2026-06-25"},
        ...
        {"@type":"Service","@id":url+"#service","name":"Delaware QuickBooks Migration","serviceType":"QuickBooks Desktop-to-Online migration","description":"Professional QuickBooks migration for Delaware businesses — Desktop-to-Online and cross-platform, with data conversion, chart-of-accounts restructuring, historical reconciliation, integration replacement, and CPA-coordinated handoff, by a Certified ProAdvisor. Independent Certified QuickBooks ProAdvisor firm; not affiliated with Intuit Inc.; does not file Delaware returns or the franchise tax — coordinates with the client's CPA, EA, and registered agent.","provider":{"@id":"https://techbrot.com/#organization"},"areaServed":{"@type":"State","name":"Delaware","sameAs":"https://en.wikipedia.org/wiki/Delaware"},
          "audience":{"@type":"BusinessAudience","audienceType":"Delaware small and mid-sized businesses migrating to QuickBooks Online from Desktop or another accounting platform"},
