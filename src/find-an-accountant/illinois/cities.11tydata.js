...
const cities = [
  ...
  { name: "Peoria", note: "A historic heavy-equipment manufacturing center on the Illinois River &mdash; standard/job costing and the machinery exemption, a large healthcare sector, and river/barge logistics.", href: "/find-an-accountant/illinois/cities/peoria/" },
  { name: "Champaign", note: "The University of Illinois city &mdash; the Research Park tech and software startup cluster, agtech, research-grant funds, and the student economy.", href: "/find-an-accountant/illinois/cities/champaign/" },
  { name: "Bloomington", note: "Bloomington-Normal&rsquo;s insurance and EV-manufacturing economy &mdash; insurance agencies and financial services, EV/advanced-manufacturing suppliers, and Illinois State University.", href: "/find-an-accountant/illinois/cities/bloomington/" },
  { name: "Decatur", note: "Central Illinois&rsquo;s agribusiness-processing and heavy-manufacturing center &mdash; corn/soybean processing, commodity-inventory and manufacturing cost accounting, and the machinery exemption.", href: "/find-an-accountant/illinois/cities/decatur/" },
  { name: "Schaumburg", note: "A northwest-suburban corporate-office and Woodfield retail hub in Cook County &mdash; multi-entity office accounting, retail and hospitality, and the high Cook County combined sales tax.", href: "/find-an-accountant/illinois/cities/schaumburg/" },
];

const faq = [
  { q: "Which Illinois cities do you serve?", a: "We have dedicated bookkeepers and city pages for the major metros &mdash; Chicago, Aurora, Naperville, Joliet, Rockford, Springfield, Peoria, Champaign, Bloomington, Decatur, and Schaumburg &mdash; each built around that city&rsquo;s actual economy. We also serve every other city in all 102 Illinois counties remotely on QuickBooks, with the same named bookkeeper and standard." },
