...
module.exports = {
  ...
  ecosystem: [
    { eyebrow: "Cluster 01", heading: "Texas money cluster", lede: "The Texas QuickBooks and bookkeeping work that captures &ldquo;quickbooks accountant near me&rdquo; and &ldquo;bookkeeper near me&rdquo; intent &mdash; all delivered directly today under one engagement.", links: [
      { label: "TX QuickBooks Accountant / ProAdvisor", tag: "&#9733; umbrella" },
      { label: "TX Small Business Accountant" },
      { label: "TX Bookkeeping Services" },
      { label: "TX Virtual Bookkeeper" },
      { label: "Speak to a TX ProAdvisor", tag: "BOFU" },
      { label: "TX Pricing &amp; Engagement Fees" },
    ] },
    { eyebrow: "Cluster 02", heading: "Texas QuickBooks spokes", lede: "TX-specific QuickBooks ProAdvisor engagements &mdash; each scoped within the direct-service model.", links: [
      { label: "TX QuickBooks Setup" },
      { label: "TX QuickBooks Cleanup" },
      { label: "TX QuickBooks Reconciliation" },
      { label: "TX QuickBooks Migration" },
      { label: "TX QuickBooks Training" },
      { label: "TX QuickBooks Error Fixes" },
    ] },
    { eyebrow: "Cluster 03", heading: "Texas bookkeeping spokes", lede: "Recurring and project bookkeeping engagements scoped to Texas operational reality.", links: [
      { label: "TX Monthly Bookkeeping" },
      { label: "TX Cleanup &amp; Catch-Up Bookkeeping" },
      { label: "TX Urgent Bookkeeping" },
    ] },
    { eyebrow: "Cluster 04", heading: "Texas tax cluster", lede: "The genuinely Texas-specific tax stack &mdash; franchise/margin tax, origin-based sales tax, SaaS 80% taxability &mdash; covered in this pillar above.", links: [
      { label: "TX Sales Tax (6.25%+ &middot; origin-based &middot; SaaS 80%)" },
      { label: "TX Franchise Tax (margin &middot; $2.65M &middot; PIR/OIR)" },
      { label: "TX Business Tax Problems" },
    ] },
    { eyebrow: "Cluster 05", heading: "Texas industries", lede: "Vertical-specific accounting depth for Texas&rsquo;s leading sectors &mdash; each handled within the direct engagement.", links: [
      { label: "TX Oil, Gas &amp; Energy Accounting" },
      { label: "TX Construction Accounting" },
      { label: "TX Technology &amp; Professional Services" },
      { label: "TX Restaurant Accounting" },
      { label: "TX Healthcare Practice Accounting" },
      { label: "TX Real Estate Accounting" },
    ] },
    { eyebrow: "Cluster 06", heading: "Texas cities", lede: "TechBrot serves businesses in every Texas metro &mdash; the major population and business centers below, and all 254 counties via remote delivery.", links: [
      { label: "Houston (Harris County)" },
      { label: "San Antonio (Bexar County)" },
      { label: "Dallas (Dallas County)" },
      { label: "Austin (Travis County)" },
      { label: "Fort Worth (Tarrant County)" },
      { label: "El Paso (El Paso County)" },
      { label: "Arlington (Tarrant County)" },
      { label: "Plano (Collin County)" },
    ] },
  ],
  ecosystemNote: "Dedicated Texas city, industry, and service pages publish on a rolling cadence. Until each goes live, every Texas engagement is delivered directly &mdash; <a href=\"/contact/?intent=texas&state=texas&source_type=location&funnel_stage=MOFU\">start with a discovery call &rarr;</a>.",
