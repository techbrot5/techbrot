...
module.exports = {
  ...
  faq: [
    ...
    { q: "How do you handle a marina's mixed revenue?", a: "A marina mixes streams that are taxed differently &mdash; slip rental (which can carry service-taxability treatment), fuel, dry storage, parts, and repair labor. We separate them in the books so the right tax is applied to each and so you can see margin by department, instead of a blended number that hides which part of the operation makes money." },
