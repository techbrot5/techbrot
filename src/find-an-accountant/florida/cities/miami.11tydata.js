...
module.exports = {
  ...
  description: "Certified QuickBooks ProAdvisor bookkeeping for Miami businesses — fluent in international trade, finance & real-estate accounting, Florida's no-income-tax structure, 7% sales tax, and the commercial-rent sales tax. Fixed-fee. Call (877) 751-5575.",
  breadcrumb: [
    { name: "Home", href: "/" },
  ...
  ctaBand: {
    ...
    lede: "30 minutes. We review where your books stand and your Miami context &mdash; international and multi-currency activity, real-estate and commission structure, the 7% sales tax, the commercial-rent sales tax, reemployment tax &mdash; and recommend the right engagement. <strong>Written fixed-fee scope within 3 business days.</strong> No pitch. Independent firm &mdash; does not file FL taxes; coordinates with your CPA.",
    actions: [
  ...
  services: [
    ...
    { num: "04", title: "Sales- &amp; rent-tax-ready books", body: "Books structured so your CPA can file Florida sales tax and the commercial-rent tax accurately, with the corporate-income-tax position clear for C-corps.", href: "/accounting/sales-tax-compliance/", cta: "Sales tax compliance &rarr;" },
  ],

  advisoryBody: "In an international, multi-currency business, the value isn&rsquo;t categorizing a transaction &mdash; it&rsquo;s knowing your currency and intercompany flows are clean, your real-estate entities tie out, your Florida sales and rent tax are handled, and your C-corp income-tax position is clear. That judgment is what a named Miami bookkeeper brings, and what <a href=\"/accounting/advisory/fractional-cfo/\">fractional-CFO advisory</a> extends once the books are clean.",
  ...
  cityMeta: {
    ...
    description: "Certified QuickBooks ProAdvisor bookkeeping for Miami businesses — fluent in international trade, finance, and real-estate accounting, Florida's no-personal-income-tax structure (5.5% corporate income tax on C-corps), ~7% sales tax, and the commercial-rent sales tax. Fixed-fee, named bookkeeper.",
    serviceName: "Miami Bookkeeping & QuickBooks Services",
    serviceType: "Bookkeeping and QuickBooks ProAdvisor services",
    serviceDesc: "Monthly bookkeeping, cleanup, QuickBooks management, and Miami tax-aware bookkeeping — multi-currency and international-trade structure, real-estate commission and entity accounting, Florida sales tax (~7%), the commercial-rent sales tax, and the 5.5% corporate income tax for C-corps handled. CPA-ready statements monthly. Independent Certified QuickBooks ProAdvisor firm; does not file Florida returns or advise on international tax — coordinates with the client's CPA or EA.",
    areaServed: [
