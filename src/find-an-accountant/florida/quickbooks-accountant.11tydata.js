...
module.exports = {
  ...
  value: [
    ...
    { num: "04", title: "Corporate tax tracked", body: "The 5.5% corporate-tax position (where it applies) and service taxability handled in the books so your CPA can file accurately.", href: "/find-an-accountant/florida/corporate-tax-help/", cta: "Corporate tax help &rarr;" },
  ...
  advisoryBody: [
    "Florida&rsquo;s no-personal-income-tax reputation hides real obligations &mdash; the 5.5% corporate tax for C-corps, 6%+surtax sales tax, the taxability of services, and the annual tangible personal property return &mdash; and the value of a Florida QuickBooks accountant is keeping all of them right so your CPA can file cleanly and you can plan.",
  ...
  faq: [
    ...
    { q: "Does Florida really have no income tax?", a: "No personal income tax &mdash; that part of the reputation is true. But it doesn&rsquo;t mean no state obligations: C-corporations pay a 5.5% corporate income tax to the Florida Department of Revenue, there&rsquo;s 6% sales tax plus a discretionary county surtax, a tax on many services others exempt, an annual tangible personal property return, and reemployment (unemployment) tax. We build all of it into how your books are kept; your CPA files." },
    ...
    { q: "Can you clean up a messy Florida QuickBooks file?", a: "Yes &mdash; it&rsquo;s a common Florida engagement, especially when sales tax was set to one rate instead of by county surtax, or taxability of services and TPP were never tracked. We scope a one-time cleanup to a CPA-ready standard, then move into monthly bookkeeping so the file stays clean." },
