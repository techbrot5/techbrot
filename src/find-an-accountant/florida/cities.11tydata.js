...
const cities = [
  ...
  { name: "Tallahassee", note: "The state capital &mdash; state government, FSU and FAMU, a lobbying and professional-services cluster, and grant-funded nonprofits and associations.", href: "/find-an-accountant/florida/cities/tallahassee/" },
  { name: "West Palm Beach", note: "&ldquo;Wall Street South&rdquo; &mdash; hedge funds, private equity, and family offices, wealth and investment management, professional services, and luxury real estate.", href: "/find-an-accountant/florida/cities/west-palm-beach/" },
  { name: "Fort Myers", note: "Southwest Florida&rsquo;s growth hub &mdash; construction and real-estate development, retirement and healthcare/home-health, and Gulf tourism.", href: "/find-an-accountant/florida/cities/fort-myers/" },
  { name: "Gainesville", note: "The University of Florida city &mdash; UF Health and medical research, a biotech and life-sciences startup cluster, and the student economy.", href: "/find-an-accountant/florida/cities/gainesville/" },
  { name: "Lakeland", note: "The I-4 logistics corridor &mdash; warehousing and 3PL/distribution, manufacturing, trucking, and Polk County citrus and agribusiness.", href: "/find-an-accountant/florida/cities/lakeland/" },
];

const faq = [
  { q: "Which Florida cities do you serve?", a: "We have dedicated bookkeepers and city pages for the major metros &mdash; Miami, Orlando, Tampa, Jacksonville, Fort Lauderdale, St. Petersburg, Tallahassee, West Palm Beach, Fort Myers, Gainesville, and Lakeland &mdash; each built around that city&rsquo;s actual economy. We also serve every other city in all 67 Florida counties remotely on QuickBooks, with the same named bookkeeper and standard." },
